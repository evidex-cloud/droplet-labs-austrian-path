...
## @hook
这是一张可以撕下来贴在墙上的纸：**40 个概念**各配一句定义和教它的那一课，**20 个人物**各配生卒年与一项贡献，**25 个关键年份**，**12 本按顺序读的书**，以及贯穿全课的**四条主线**。它不教新东西，它把你已经学过的东西压成一页——当你在[[capstone|阶段 ∞.3]] 写毕业设计、或者五年后在某场争论里忽然想不起“回归定理到底说了什么”时，从这里查。演示区是它的可搜索版本，每一行都能点回对应的课。
...
怎么用这张表：**不要背**。第一遍从头扫一遍，找出你看到定义仍然说不出“为什么”的那些词——那就是你该回去复习的课。第二遍在写作时查（[[writing-argument|阶段 14.2]]）：引用人名年份之前，先对一下。第三遍在[[capstone|阶段 ∞.3]] 的毕业设计里当清单用：一篇合格的奥派分析，通常至少会调用表中 8–10 个概念。
...
- **主观价值** —— 价值是行动人对物品能否满足其目的的评价，不是物品的属性（[[subjective-value|阶段 1.2]]）。
- **边际效用递减** —— 每多一单位被分配到更次要的用途，所以每一单位的价值等于边际那一单位；从行动逻辑推出，不是心理学（[[diamonds-water|阶段 1.1]]）。
- **边际对** —— 庞巴维克：市场价被夹在最后一对成交者与第一对未成交者的估值之间（[[price-formation|阶段 1.3]]）。
- **机会成本与看不见的** —— 成本是你放弃的最有价值的替代；巴斯夏的好经济学家看见“不存在的东西”（[[opportunity-cost|阶段 1.4]]）。
- **比较优势** —— 即使你样样更强，专注相对最强的事再交换，双方总产出更高；米塞斯称之为联合法则（[[exchange-division|阶段 1.5]]）。
- **行动公理** —— 人有目的地行动；否认它本身就是一个有目的的行动（[[action-axiom|阶段 2.1]]）。
- **人的行动学** —— 从行动公理逻辑演绎经济规律的方法，而不是从统计归纳（[[apriori-empirical|阶段 2.2]]）。
- **先验** —— 不靠经验观察就知道为真的命题；统计既不能证实也不能证伪它（[[apriori-empirical|阶段 2.2]]）。
- **方法论个人主义** —— 只有个人会行动、评价、选择；“国家”“市场”不会（[[individualism-history|阶段 2.3]]）。
- **均匀轮转经济** —— 米塞斯的思维实验：没有变化和不确定性的经济，用来反衬利润从哪来（[[vs-math-models|阶段 2.4]]）。
- **时间偏好** —— 其他条件相同，人偏好现在的满足胜过未来；利息由此而来（[[time-preference|阶段 3.1]]）。
- **迂回生产** —— 先造工具再生产，更费时但更多产；庞巴维克（[[roundabout-production|阶段 3.2]]）。
- **哈耶克三角** —— 一张图：横轴生产时间，纵轴各阶段价值；利率决定它的形状（[[roundabout-production|阶段 3.2]]）。
- **生产结构** —— 从原料到消费品的一系列阶段；储蓄拉长它，消费缩短它（[[saving-stages|阶段 3.3]]）。
- **异质资本** —— 资本品不是同质的“K”，而是各有专用性的拼图块；拉赫曼（[[heterogeneous-capital|阶段 3.4]]）。
- **自然利率** —— 由储蓄者与投资者的时间偏好决定的利率；市场利率被信贷压低于它就撒了谎（[[natural-rate|阶段 3.5]]）。
- **回归定理** —— 米塞斯：货币今天的购买力回溯自昨天，直到它还是普通商品的那一天（[[origin-of-money|阶段 4.1]]）。
- **可销售性** —— 门格尔：货币是可销售性最高的商品演化出来的，不是发明出来的（[[origin-of-money|阶段 4.1]]）。
- **货币非中性** —— 新钱不是均匀落下的雨，它改变相对价格与财富分配（[[money-demand|阶段 4.2]]）。
- **坎蒂隆效应** —— 先拿到新钱的人以旧价格买东西，后拿到的人承受涨价（[[cantillon-inflation|阶段 4.3]]）。
- **信用扩张** —— 部分准备金银行创造没有储蓄支撑的贷款，压低市场利率（[[fractional-reserve|阶段 4.4]]）。
- **法币** —— 靠法律而非商品支撑的货币；1971 年之后的世界（[[central-banks-fiat|阶段 4.5]]）。
- **奥地利学派商业周期理论** —— 人为压低的利率诱发错误投资，繁荣必然以萧条清算收场（[[abct-one-picture|阶段 5.1]]）。
- **错误投资** —— 不是“投资太多”，而是投错了阶段：只在假利率下看起来划算的项目（[[boom-malinvestment|阶段 5.2]]）。
- **强制储蓄** —— 信用扩张把资源从消费者手里转到投资者手里，而消费者并未选择少消费（[[boom-malinvestment|阶段 5.2]]）。
- **清算** —— 萧条是错误投资被重新配置的过程，是治疗不是疾病（[[bust-liquidation|阶段 5.3]]）。
- **崩溃繁荣** —— 米塞斯：若信用扩张永不停止，公众对货币失去信心，终点是恶性通货膨胀（[[bust-liquidation|阶段 5.3]]）。
- **企业家精神** —— 柯兹纳的警觉（发现被忽视的机会）与米塞斯的判断（在不确定下押注）（[[entrepreneur-alertness|阶段 6.1]]）。
- **发现程序** —— 哈耶克：竞争是发现谁能以什么成本做什么的程序，而不是一种状态（[[competition-process|阶段 6.2]]）。
- **消费者主权** —— 利润与亏损把资源交给最能服务消费者的人；企业家是替消费者跑腿的船长（[[profit-loss|阶段 6.3]]）。
- **经济计算** —— 米塞斯 1920：没有生产资料的市场价格，就没法比较不同用途的成本（[[mises-1920|阶段 7.1]]）。
- **知识问题** —— 哈耶克 1945：决策所需的知识分散在无数人头脑里，且随时间地点变化（[[hayek-knowledge|阶段 7.2]]）。
- **默会知识** —— 说不出来但用得上的知识（“这个客户快跑了”）；它无法被集中（[[hayek-knowledge|阶段 7.2]]）。
- **自发秩序** —— 人的行动的结果，而非人的设计的结果：语言、货币、普通法、市场（[[spontaneous-order|阶段 7.4]]）。
- **干预主义** —— 米塞斯：每次干预制造新问题，召唤下一次干预；中间道路走不通（[[intervention-logic|阶段 8.1]]）。
- **寻租** —— 用资源去争取政府赐予的特权，而不是去服务消费者；公共选择学派（[[economics-of-state|阶段 8.4]]）。
- **先占原则** —— 对无主物的首先使用建立产权；洛克与罗斯巴德（[[why-property|阶段 9.1]]）。
- **自由银行** —— 无央行、可竞争发钞的银行制度；塞尔金与怀特 vs 百分百准备金派（[[free-banking|阶段 9.4]]）。
- **网络效应** —— 你的估值取决于别人是否也在用；主观价值论的一个特例而非例外（[[network-effects|阶段 15.1]]）。
- **反身性** —— 索罗斯：价格影响基本面，基本面又影响价格；与奥派的预期与不确定性相接（[[memes-reflexivity|阶段 16.5]]）。
...
- **3. 门格尔《国民经济学原理》（1871）** —— 学派的种子：主观价值、商品级别、货币起源；[[read-menger|阶段 12.1]] 有导读。
- **4. 罗斯巴德《政府对我们的货币做了什么？》（1963）** —— 一百页讲清货币的起源与国家如何接管它。
- **5. 哈耶克《个人主义与经济秩序》（1948）** —— 收录 1937《经济学与知识》、1945《知识在社会中的运用》、1946《竞争的含义》。
- **6. 米塞斯《社会主义国家的经济计算》（1920）** —— 三十页的论文，计算争论的原点；配[[mises-1920|阶段 7.1]]。
- **7. 罗斯巴德《人、经济与国家》（1962）** —— 体系的教科书版：从行动公理一路推到垄断与干预；[[read-rothbard|阶段 12.4]]。
- **8. 米塞斯《人的行动》（1949）** —— 体系的原版；[[read-human-action|阶段 12.2]] 给了 900 页的地图。
- **9. 米塞斯《货币与信用理论》（1912）** —— 回归定理与周期理论的源头；读过第 8 本再读它。
- **10. 柯兹纳《竞争与企业家精神》（1973）** —— 企业家、警觉、市场过程；[[entrepreneur-alertness|阶段 6.1]]。
- **11. 加里森《时间与货币》（2001）** —— ABCT 的现代图示版；[[garrison-macro|阶段 10.1]]。
- **12. 德索托《货币、银行信贷与经济周期》（1998）** —— 部分准备金的法律史加周期理论的集大成；[[fractional-reserve|阶段 4.4]] 与 5.x 的总复习。

读完 12 本之后：拉赫曼《资本及其结构》（1956）、哈耶克《法律、立法与自由》（1973–79）、罗斯巴德《美国大萧条》（1963）、霍普《民主：失败的上帝》（2001）、莱奥尼《自由与法律》（1961）。[[internal-debates|阶段 14.3]] 会告诉你这些书之间哪些地方在吵架。

### ⑤ 四条主线与一页地图

整门课只有四句话，所有 40 个概念都挂在它们上面：

- **价值是主观的** —— 边际效用、边际对、机会成本、归属、消费者主权、网络效应（[[diamonds-water|阶段 1]] 与 15）。
- **人有目的地行动** —— 行动公理、先验、方法论个人主义、企业家的判断、对总量与模型的怀疑（[[action-axiom|阶段 2]]、6、10.2、11）。
- **价格传递知识** —— 经济计算、知识问题、发现程序、自发秩序、对大数据与 AI 计划的回答（[[mises-1920|阶段 7]]、15.4、18.1）。
- **时间与不确定性无法消去** —— 时间偏好、生产结构、自然利率、信用扩张、错误投资、周期（[[time-preference|阶段 3]]、4、5、10、17.5、18.5）。
...
最后一个提醒：这张表把学派压成了一页，代价是**把争论压没了**。表里说“回归定理”，[[bitcoin-regression|阶段 17.1]] 会告诉你它对比特币是否成立仍有争议；表里说“自由银行”，[[free-banking|阶段 9.4]] 与 14.3 会告诉你学派在这上面分裂成两半；表里说“清算是治疗”，[[vs-chicago|阶段 11.2]] 会告诉你哈耶克晚年承认 1930–33 年的二次通缩不该放任。速查表是索引，不是判决书。

## @analogy
把这门课想成你走过的一座**城市**。前面十四个阶段，你是步行穿过它的：在[[diamonds-water|阶段 1]] 的市场广场学会看价格，在[[time-preference|阶段 3]] 的工厂区看见迂回生产的流水线，在[[origin-of-money|阶段 4]] 的银行街看见新钱从哪一扇门流出，在[[mises-1920|阶段 7]] 的图书馆里看见哈耶克讲知识为什么装不进一本书，在[[network-effects|阶段 15–18]] 的新城区看见同样的街道规则怎么适用于平台、比特币和算力中心。
...
你不会拿着地铁图去欣赏城市——它太简陋了。但当你在某个陌生的街角迷路（“回归定理到底是在说什么？”“清算和通缩是一回事吗？”），你会掏出它，找到最近的站，坐回去看一眼。而且，当你要给别人介绍这座城市（[[writing-argument|阶段 14.2]]）或者自己规划一条新的线路（[[capstone|阶段 ∞.3]]），你会先在地铁图上把换乘点标好。

地铁图的最后一个用处：它让你看见**哪些站还没修好**。图上有些线路是虚线——自由银行还是百分百准备金、均衡趋向还是万花筒、比特币是不是货币——那是[[internal-debates|阶段 14.3]] 与[[open-problems|阶段 ∞.1]] 的工地。一张诚实的地图会把工地也画上。
...
- **“表里列的都是奥派的定论。”** —— 表里至少有四处仍在争论：回归定理对比特币是否成立（[[bitcoin-regression|阶段 17.1]]）、自由银行还是百分百准备金（[[free-banking|阶段 9.4]]）、市场是否趋向均衡（拉赫曼）、垄断价格是否存在于自由市场（米塞斯 vs 罗斯巴德）。[[internal-debates|阶段 14.3]] 专门讲这些分歧；速查表为了压缩把争论压没了，读者要自己补回来。
- **“12 本书要按顺序读完才能开始用奥派。”** —— 顺序是推荐，不是门槛。前两本（哈兹利特与巴斯夏）加上本课的[[diamonds-water|阶段 1–8]]，已经足够让你用五步法分析一项政策。原著的作用是把你的理解从“能用”提高到“能辩护、能修正”。
- **“熊彼特是奥派，他讲创造性破坏。”** —— 熊彼特在维也纳受教于庞巴维克，但他的方法（瓦尔拉斯式均衡出发、企业家作为均衡的破坏者）与奥派主流相距甚远，他自己也不认同奥派。课程借用“创造性破坏”一词（[[creative-destruction|阶段 15.5]]），但要知道它的来源不在表内。
- **“1974 年哈耶克得诺贝尔奖，说明奥派回到了主流。”** —— 那一年是复兴的起点，不是终点。哈耶克与冈纳·缪尔达尔分享奖项，获奖理由是货币与周期理论和对制度的分析；之后奥派仍长期处于主流经济学系的边缘（[[vienna-lineage|阶段 0.3]] 与 14.5）。年份表记录的是转折，不是胜利。

## @quiz
1. 下面哪一组年份与事件对应正确？
   - [ ] 1912 米塞斯《人的行动》；1949 米塞斯《货币与信用理论》
   - [x] 1871 门格尔《国民经济学原理》；1920 米塞斯《社会主义国家的经济计算》；1974 哈耶克获诺贝尔奖
   - [ ] 1936 哈耶克《通往奴役之路》；1944 凯恩斯《通论》
   - [ ] 1962 罗斯巴德《美国大萧条》；1963 柯兹纳《竞争与企业家精神》
   > 1871 边际革命、1920 计算争论开场、1974 诺贝尔奖与复兴——三个转折点。其余选项把年份互换了：《人的行动》是 1949，《货币与信用理论》是 1912；《通论》1936、《通往奴役之路》1944；《美国大萧条》1963、柯兹纳 1973。

2. “新钱先到谁手上，谁就能以旧价格买东西”——这个概念叫什么，最早由谁提出？
   - [ ] 回归定理，米塞斯
   - [ ] 强制储蓄，哈耶克
   - [x] 坎蒂隆效应，理查德·坎蒂隆
   - [ ] 货币均衡，塞尔金
   > 坎蒂隆（约 1680–1734）在《商业性质概论》里描述了新钱从注入点扩散、改变相对价格的过程，[[cantillon-inflation|阶段 4.3]] 详述；回归定理讲的是货币购买力的历史连续性。

3. 按本课推荐的阅读顺序，为什么《一课经济学》排在《人的行动》之前？
   - [ ] 因为哈兹利特比米塞斯更重要
   - [x] 因为顺序原则是先直觉后体系、先短后长：两小时装上“看不见的”眼镜，再去啃 900 页的体系
   - [ ] 因为《人的行动》已经绝版
   - [ ] 因为《一课经济学》包含了《人的行动》的全部内容
   > 阅读顺序的原则是**先直觉后体系、先短后长、先价格后货币再周期**。哈兹利特是入口，米塞斯是体系；[[read-human-action|阶段 12.2]] 给了读《人的行动》的地图。

4. 四条主线里，“经济计算”“知识问题”“自发秩序”挂在哪一条上？
   - [ ] 价值是主观的
   - [ ] 人有目的地行动
   - [x] 价格传递知识
   - [ ] 时间与不确定性无法消去
   > 第三条主线：价格把分散的知识压缩成数字，没有价格就没有计算；米塞斯 1920 与哈耶克 1945 是它的两块基石，[[mises-1920|阶段 7]] 整个阶段展开它。

5. 速查表里哪一项在学派内部仍有实质争论，而不是定论？
   - [ ] 边际效用递减是从行动逻辑推出的
   - [x] 自由银行 vs 百分百准备金
   - [ ] 价值是主观的
   - [ ] 只有个人会行动
   > 自由银行（塞尔金、怀特）与百分百准备金（罗斯巴德、霍普、德索托）是学派内部最持久的分歧之一，[[free-banking|阶段 9.4]] 与 14.3 详述；其余三项是全学派共享的地基。

## @further
- [Mises Institute：Austrian Economics — An Introduction（学派概览与人物）](https://mises.org/austrian-economics)
- [Econlib 百科：Austrian School of Economics（Peter Boettke）](https://www.econlib.org/library/Enc/AustrianSchoolofEconomics.html)
- [Mises Institute 图书馆：本课 12 本书中多数可免费在线阅读](https://mises.org/library)
- [Econlib：Bastiat 全集（“看得见的与看不见的”“经济诡辩”）](https://www.econlib.org/library/Bastiat/basEss.html)
- [Hayek 1974 年诺贝尔演讲 “The Pretence of Knowledge”](https://www.nobelprize.org/prizes/economic-sciences/1974/hayek/lecture/)
