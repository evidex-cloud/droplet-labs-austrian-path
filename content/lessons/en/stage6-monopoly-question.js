export default {
  ...
  stage: 6,
  order: 4,
  title: "The Monopoly Question: Why Austrians Don't Fear 'Big'",
  difficulty: "core",
...
$$
Competition: P = MC → 100 − Q = 20 → Q = 80, P = 20; consumer surplus = ½ × 80 × 80 = 3,200
Monopoly: MR = 100 − 2Q = 20 → Q = 40, P = 60; profit = (60 − 20) × 40 = 1,600
Consumer surplus under monopoly = ½ × 40 × 40 = 800; deadweight loss = ½ × 40 × 40 = 800
$$
...
**Step one: every seller “restricts output.”** The diagram says the monopolist “cuts output from 80 to 40.” But every seller — down to the smallest bakery — decides “how much to produce” and stops where “one more would lose money.” A bakery that bakes 200 loaves a day rather than 300 is also “restricting.” To call some output a “restriction” you must first know the “unrestricted” output — and that number exists only in the perfect-competition model, which, as Stage 6.2 showed, describes a world that does not exist.

**Step two: “marginal cost” is not an observable benchmark.** In the diagram MC = 20 is a flat line anyone can see. In the real world costs are each firm's own, change over time, and embody judgments about the future (Stage 6.1). Moreover, if firms priced at marginal cost, any firm with fixed costs would lose money (the marginal cost of copying software is zero — Stage 15.3). So the test “P > MC means monopoly” would convict nearly every firm in existence.
...
- **Entrepreneurial position**: a firm is the **only** seller of some product — not because others cannot, but because others **have not yet**. It invented the product, or does it better than anyone. That is **not a monopoly**, because entry is free: every dollar of its profit is an invitation to other entrepreneurs (Stage 6.3), and every day its position exists it is winning a discovery race.
...
The dispute is unresolved to this day. Kirzner stands roughly in the middle: he accepts “resource monopoly” as meaningful (closer to Mises) but stresses that it is extremely rare and requires no antitrust law to handle (closer to Rothbard). Stage 14.3 places this in the full map of Austrian internal disagreements. **Our suggestion: do not rush to pick a side; memorize the test** — was this firm's position voted in by consumers, or fenced in by law?

The ruler in use today:

- **Platforms (Stage 15.2).** Google holds about 90% of search; nearly everyone in China uses WeChat — are they monopolies? Apply the test: is there a law forbidding anyone from building a search engine or a messaging app? No. Is their position tested every day? Yes — every single search can go elsewhere. Network effects (Stage 15.1) genuinely raise the bar for entrants, a contemporary problem Austrians must take seriously; but a high bar is not a locked door (TikTok went from zero to a billion users in a few years).
- **Licensing (Stage 8.3).** Taxi medallions, occupational licenses, certificates of need — these are the structures in the textbook diagram that can restrict output and raise price, because entry is forbidden by law. Austrians hold that if antitrust fire is to be opened at all, it should be aimed here first.
...
`,
  ...
  quiz: [
    {
      q: "Demand is P = 100 − Q and marginal cost is 20. On neoclassical theory, what output and price does the monopolist choose?",
      options: [
        "Q = 80, P = 20",
        "Q = 50, P = 50",
        "Q = 40, P = 60",
      ...
      answer: 2,
      explain: "MR = 100 − 2Q = MC = 20 → Q = 40; substituting into demand gives P = 60; profit (60−20)×40 = 1,600, deadweight loss ½×40×40 = 800. Austrians do not question this geometry; they question whether the “MC = 20 competitive benchmark line” is observable in the real world.",
    },
    {
      q: "What is Rothbard's core reason for holding that a “monopoly price” cannot be defined on a free market?",
      options: [
        "Because monopolists conceal their prices",
        "Because every seller decides its output, and calling one output a “restriction” requires an observable “competitive output” that exists only in the perfect-competition model",
        "Because price always equals marginal cost",
        "Because consumers do not care about prices",
      ],
      answer: 1,
      explain: "A bakery that bakes 200 loaves instead of 300 is also “restricting.” To call an output a restriction you must know the unrestricted output — and that number comes from a world that does not exist (Stage 6.2). So Rothbard keeps only one definable monopoly: state-granted exclusive privilege.",
    },
    {
      q: "On what conclusion do contestable-market theory (Baumol et al., 1982) and Kirzner's “entrepreneurial position” agree?",
      options: [
        "What disciplines a firm's pricing is not the number of existing rivals but the freedom of potential rivals to enter",
      ...
      answer: 0,
      explain: "If entry and exit are cheap enough, even a single firm dares not price above the competitive level, or potential entrants will “hit and run.” That is Kirzner's point exactly: the sole seller is no monopolist as long as others “have not yet” rather than “cannot” enter.",
    },
    {
      q: "What was Armentano's reading of the 1945 ALCOA case?",
      options: [
        "ALCOA was found guilty because it raised aluminum prices",
        "ALCOA was found guilty because it anticipated demand growth and met it with new capacity — i.e., it expanded too fast and priced too low to leave room for rivals",
        "The ALCOA case was eventually dropped",
        "ALCOA monopolized aluminum through a government charter",
      ],
      answer: 1,
      explain: "Judge Hand acknowledged ALCOA had committed no unlawful exclusionary act, yet found it guilty for “embracing every new opportunity.” Armentano argued this exposes antitrust logic: the conduct punished is exactly what consumers most want. Note this is “he argued” — the case remains contested.",
    },
    {
      q: "What is the Austrian internal disagreement about whether a “monopoly price” can exist on a free market?",
      options: [
        ...
        "Mises held it can exist with control of total supply plus inelastic demand; Rothbard held the concept is undefinable and discarded it",
      ],
      answer: 3,
      explain: "An unfinished Austrian argument: Chapter XVI of Human Action retains the monopoly-price concept; Chapter 10 of Man, Economy, and State holds it requires an unobservable competitive benchmark and keeps only the “state-granted privilege” definition. Kirzner sits between them (Stage 14.3).",
    },
  ],

  further: [
    { label: "Rothbard, Man, Economy, and State, Chapter 10, “Monopoly and Competition” — the original argument that a monopoly price cannot be defined", url: "https://mises.org/library/book/man-economy-and-state-power-and-market" },
    { label: "Mises, Human Action, Chapter XVI, “Prices,” Section 6, “Monopoly Prices” — Mises's own theory of monopoly price", url: "https://mises.org/library/book/human-action" },
    { label: "Dominick Armentano, Antitrust and Monopoly: Anatomy of a Policy Failure (1982; 2nd ed. 1990) — the case-by-case re-examination", url: "https://mises.org/library/book/antitrust-and-monopoly-anatomy-policy-failure" },
    { label: "Kirzner, Competition and Entrepreneurship (1973), Chapter 3 — resource monopoly versus entrepreneurial position", url: "https://mises.org/library/book/competition-and-entrepreneurship" },
    { label: "Econlib Concise Encyclopedia: Antitrust — including contestable-market theory and the Chicago revision of antitrust", url: "https://www.econlib.org/library/Enc/Antitrust.html" },
  ],
};
