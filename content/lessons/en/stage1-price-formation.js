...
Will they trade? Yes — at any price between 10 and 30 both are better off than not trading: A1 ranks the horse above, say, $20, and B1 ranks $20 above the horse. That is the “reversed ranking” of Stage 1.2. **But what will the price be? Theory can say only: somewhere between 10 and 30.** Whether it lands at 12 or 28 depends on who is in more of a hurry, who negotiates better, who can better pretend not to care — and economics has nothing further to say about that. This is the zone of price indeterminacy under **bilateral monopoly**, twenty dollars wide.
...
$$
Buyers (max): A1 30 · A2 28 · A3 26 · A4 24 · A5 22 · A6 21 · A7 20 · A8 18 · A9 17 · A10 15
Sellers (min): B1 10 · B2 11 · B3 15 · B4 17 · B5 20 · B6 21.5 · B7 25 · B8 26
$$
...
- **Every point on the curve is a person (or one unit of a person's demand).** “Demand slopes downward” is not an experimental law; it is the inevitable result of ranking valuations from high to low — Stage 1.1 derived it from the logic of action.
...
This way of seeing runs all the way through the course. In Stage 1.5 on exchange and the division of labor you will see that every trade is a pair of reversed rankings, and that more trades mean deeper specialization. In Stage 9.4 on free banking and Stage 15.2 on platform competition, “is there a second person at the margin drawing a line under the price?” becomes the real test of “monopoly.” And in Stage 17.4 you will meet an instructive contrast: the **automated market makers** (AMMs) of decentralized exchanges quote prices by formula (for instance, “the product of the two token inventories stays constant”) — a price-formation rule written into code. But note how it differs from the horse market: the AMM **knows nobody's valuation**; it quotes mechanically from inventory. What actually brings the outside world's rankings into it are the traders who see its quote drift from other markets and step in to arbitrage — they are the machine's A5 and B6. **Without people at the margin, any pricing formula is a calculator that does not know what it is computing.** Stage 18.6 on algorithmic pricing returns to that principle.
...
`,
  ...
  quiz: [
    {
      q: "In Böhm-Bawerk's horse market (10 buyers, 8 sellers, numbers as in the lesson), which four people are the “marginal pairs” that draw the lines around the price?",
      options: [
        "A1, A10, B1, B8 — the extreme values",
        "A5 and B5 (the last pair that trades) with A6 and B6 (the first pair that does not)",
        "The four people whose valuations are closest to the average",
        "All the buyers and sellers who trade",
      ],
      answer: 1,
      explain: "Ceiling = min(A5's 22, B6's 21.5) = 21.5; floor = max(B5's 20, A6's 21) = 21. The price is pinned between 21 and 21.5 by those four marginal traders; everyone else's valuation is irrelevant as long as it does not cross the margin.",
    },
    {
      q: "A1 raises his maximum bid from 30 to 100. What happens to the market price?",
      options: [
        "It rises a lot, because the highest bid rose",
        "It rises a little, because the average bid rose",
        "Nothing — A1 was always going to get a horse; he is not at the margin",
        "It falls, because other buyers are scared off",
      ],
      answer: 2,
      explain: "The price is sensitive only to changes at the margin. A1 is in the first pair, far above the margin; whatever he bids, the fifth and sixth pairs match exactly as before.",
    },
    {
      q: "A new buyer A0 with a maximum of 23 enters the horse market. What happens to quantity and to the price band?",
      options: [
        "Quantity unchanged, band unchanged",
        "Six horses trade, and the band moves up to 21.5–22",
        "Four horses trade, and the price falls",
        "Six horses trade, and the price is fixed at 23",
      ],
      answer: 1,
      explain: "After re-ranking, the sixth pair is A5 (22) with B6 (21.5), which trades; the seventh, A6 (21) with B7 (25), does not. Ceiling = min(22, 25) = 22, floor = max(21, 21.5) = 21.5. A0 himself pays about 22, well under his 23.",
    },
    {
      q: "Why do Austrians stress that the horse market has “no auctioneer”?",
      options: [
        "Because auctioneers charge fees",
        "Because each person knows only his own valuation and reacts only to the offers he sees, yet the price forms anyway — the market is a discovery process needing no central coordinator",
        "Because Böhm-Bawerk opposed auctions",
        "Because auctioneers cause monopoly",
      ],
      answer: 1,
      explain: "Walras's auctioneer is a fiction adopted to make general-equilibrium mathematics work. In a real market the price grows out of dispersed local decisions — the seed of Stage 7.2's knowledge problem and Stage 6.2's discovery procedure.",
    },
    {
      q: "An automated market maker (AMM) on a decentralized exchange quotes prices by formula. In this lesson's framework, what is its crucial difference from the horse market?",
      options: [
        "The AMM is more precise and therefore needs no marginal traders",
        "The AMM knows nobody's valuation and quotes mechanically from inventory; the arbitrageurs who step in bring the real rankings — they are its marginal pairs",
        "The AMM's price is the just price",
        "The AMM proves prices can exist without subjective value",
      ],
      answer: 1,
      explain: "A pricing formula is a rule written in code, not a source of valuations. Without people at the margin, any formula is a calculator that does not know what it is computing — Stage 17.4 develops this.",
    },
  ],

  further: [
    { label: "Böhm-Bawerk, Capital and Interest, Vol. II: Positive Theory of Capital (1889), Book IV “Price” — the horse market and the marginal pairs in the original (Mises Institute)", url: "https://mises.org/library/book/capital-and-interest-three-volumes" },
    { label: "Rothbard, Man, Economy, and State, Ch. 2 “Direct Exchange” — the modern Austrian derivation of market price from marginal pairs", url: "https://mises.org/library/book/man-economy-and-state-power-and-market" },
    { label: "Mises, Human Action, Ch. XVI “Prices” — the price-formation process and the “final price” as a thought tool", url: "https://mises.org/library/book/human-action" },
    { label: "Econlib Encyclopedia: Supply — the mainstream presentation of supply and demand curves, for comparison with the staircase", url: "https://www.econlib.org/library/Enc/Supply.html" },
    { label: "Econlib Encyclopedia: Austrian School of Economics — a concise overview of price formation and the market process", url: "https://www.econlib.org/library/Enc/AustrianSchoolofEconomics.html" },
  ],
};
