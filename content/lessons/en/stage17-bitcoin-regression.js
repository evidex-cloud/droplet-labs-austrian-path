export default {
  ...
  stage: 17,
  order: 1,
  title: "Is Bitcoin Mengerian Money? The Regression-Theorem Debate",
  difficulty: "newera",
  ...
  intuition: `
Start by recalling the two bricks from Stage 4.1. The first is Menger's: money was not invented; it **grew** out of barter. Some good, because it was the easiest to sell, got used by more and more people as a stepping-stone, and the snowball rolled until one commodity was accepted by everyone. The second is Mises's: that story has a circle in it — people accept money because it has purchasing power, and it has purchasing power because people accept it. Mises's **regression theorem** straightens the circle into a line: today's demand for money refers back to yesterday's purchasing power, yesterday's to the day before, all the way back to the day the thing was an ordinary commodity with only “use value.” Gold was jewellery before it was money; silver was tableware. **The far end of the chain has to be anchored in a non-monetary value.**
...
- **Fourth (its character).** This is an **a priori**, praxeological theorem (Stage 2.2): not induced from history but deduced from the fact that people can only choose on the basis of valuations they already have. So it must hold for every money, **including future ones.**

Now note three things the theorem does **not** claim, because the whole debate is fought on exactly these boundaries:

1. **It does not claim money must keep a commodity use forever.** Mises says plainly that once monetary demand exists the commodity use may vanish (fiat money is precisely an unbroken chain: the dollar's purchasing power traces to the pre-1971 gold promise, and from there to gold's use as ornament — Stage 4.5).
2. **It does not claim the “non-monetary use” must be physical.** Mises speaks of “use value” — a person's valuation of the thing's capacity to serve some end. Ends are subjective (Stage 1.2). A postage stamp's use value is posting letters; a game item's use value is playing the game.
...
**Fourth objection, in the Hoppe–Hülsmann line:** money-ness comes from saleableness, and one source of saleableness is **physical certainty** — you can hold gold in your hand, whereas Bitcoin's continued existence depends on miners staying switched on, the protocol not being broken, and the internet persisting. This does not say it cannot be money; it says its money-ness has a layer of dependencies gold lacks. The point returns in Stage 17.5 when we discuss custody and “paper bitcoin.”
...
The question to ask at that point is not “are the cards a scam?” nor “how high can they go?” but the one Stage 4.2 taught: **what are they being used for right now?** The answer: they are being **held**, not **spent**. So they are a very saleable asset, and not yet money. Whether that changes depends on the people outside the club — not on the rule sheet.
`,

  misconceptions: [
    "**“Bitcoin has no intrinsic value, so it violates the regression theorem, so it's a scam.”** — Three errors in a row. Austrians never accept “intrinsic value” (Stage 1.2: value lives in minds, not things); the theorem requires a *prior non-monetary valuation*, which most Austrian writers find in the 2009 collectible/experimental/ideological uses; and whether the theorem is satisfied has nothing to do with whether something is a scam.",
  ...
  quiz: [
    {
      q: "What problem does Mises's regression theorem solve?",
      options: [
        "Who should issue money",
        "The circularity that money demand depends on purchasing power while purchasing power depends on money demand",
        "Why gold suited money better than silver",
        "Why inflation redistributes wealth",
      ],
      answer: 1,
      explain: "The theorem straightens the “Austrian circle” into a causal chain with an arrow of time: today's demand refers to yesterday's purchasing power, back to the day the good had only non-monetary uses.",
    },
    {
      q: "What “first link” did Graf (2013) propose for Bitcoin's compliance with the regression theorem?",
      options: [
        "Bitcoin could buy pizza",
        "El Salvador made it legal tender",
        "Its 2009 non-monetary utility as a collectible, geek toy and cryptographic experiment",
        "Its supply cap of 21 million",
      ],
      answer: 2,
      explain: "Graf divides Bitcoin's evolution into collectible → first quote → first real-goods exchange (Pizza Day) → continuous market price; the first link is a subjective valuation of playing with a novel artefact, not a physical commodity use.",
    },
    {
      q: "Which is the strongest skeptical objection to “Bitcoin is money” — and the one most proponents also concede?",
      options: [
        "It lacks gold's ornamental use",
        "It is still not a generally accepted medium of exchange; most holders hold it rather than pay with it",
        "Its code might have bugs",
        "Its price is too high for ordinary people",
      ],
      answer: 1,
      explain: "By Mises's definition money is the generally accepted medium of exchange; Bitcoin today is closer to a “secondary medium of exchange” or “monetary asset.” This is a description of the present, not an attack on the regression theorem, and most proponents say “not yet.”",
    },
    {
      q: "In the language of Stage 7.4, what is the most accurate description of Bitcoin?",
      options: [
        "A pure spontaneous order in which even the rules grew",
        "A pure organization (taxis) directed by Satoshi",
        "Designed rules (cap, halvings) around which a spontaneous ecosystem (exchanges, prices, uses) has grown",
        "An international monetary system designed jointly by governments",
      ],
      answer: 2,
      explain: "Hayek distinguished designed rules from grown order; the Bitcoin protocol is the former, while its price, uses and whole ecosystem are the latter — nobody planned a “Bitcoin economy.”",
    },
    {
      q: "From the “money vs monetary asset” angle, what did the 2024 US approval of spot Bitcoin ETFs signify?",
      options: [
        "Bitcoin thereby became money in Mises's sense",
        "It strengthened Bitcoin's store-of-value/monetary-asset side rather than its medium-of-exchange side",
        "It proved the regression theorem wrong",
        "It disabled the supply cap",
      ],
      answer: 1,
      explain: "An ETF makes it easier to hold dollar exposure to Bitcoin, not to pay with it — in a sense evidence for the skeptics' point that it is held rather than used.",
    },
  ],

  further: [
    { label: "Mises, The Theory of Money and Credit (1912), Part II — the original statement of the regression theorem (Mises Institute full text)", url: "https://mises.org/library/book/theory-money-and-credit" },
    { label: "Davidson & Block, “Bitcoin, the Regression Theorem, and the Emergence of a New Medium of Exchange,” QJAE 18(3), 2015", url: "https://mises.org/quarterly-journal-austrian-economics/bitcoin-regression-theorem-and-emergence-new-medium-exchange" },
    { label: "Konrad S. Graf, “On the Origins of Bitcoin: Stages of Monetary Evolution” (2013)", url: "https://konradsgraf.com/" },
    { label: "Frank Shostak, “The Bitcoin Money Myth” (Mises Daily, 2013) — a representative skeptic", url: "https://mises.org/mises-daily/bitcoin-money-myth" },
    { label: "Satoshi Nakamoto, “Bitcoin: A Peer-to-Peer Electronic Cash System” (2008), the original white paper", url: "https://bitcoin.org/bitcoin.pdf" },
  ],
};
