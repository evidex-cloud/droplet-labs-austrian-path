...
Knight's key proposition: **profit comes from uncertainty, not from risk.** The price of risk is computed by competition and folded into costs — an insurance premium is the price of risk; if everything were risk, the entrepreneur's return would be competed down to zero. Only where there is no distribution can someone earn more than cost by judging correctly. Mises said the same thing in different words in *Human Action*: the entrepreneurial function is to “act under uncertainty,” and profit and loss measure whether the anticipation was right (Stage 6.3).
...
**Computing risk.** Wherever a decision has a historical distribution, models are taking over fast: credit approval, demand forecasting, inventory replenishment, ad bidding, routing, price-driven scheduling. These used to be “managerial judgment”; increasingly they look like “computation that can be outsourced.” Stage 18.1 called AI “a better planner inside the price system”; this is its counterpart at the level of the entrepreneur: **within a given plan, at given prices, a model optimizes better than a person.**
...
- **Bearing.** When judgment is wrong, the loss lands on the judge. That is the core of the market feedback system in Stage 6.3: losses pull resources out of mistaken plans and hand them to people who judge better. Something that cannot lose is not in that feedback loop.
...
A footnote picking up the “hallucination” point from Stage 18.1: faced with a question outside its training distribution, a model does not say “I have no distribution”; it generates **something that looks like an answer.** On the risk side that is a minor flaw; on the uncertainty side it is fatal — because uncertainty is by definition “outside the distribution,” and that is exactly where the model's most confident errors occur. An entrepreneur who mistakes a hallucination for judgment has mistaken Knight's right side for his left. **A model does not know what it does not know, and “knowing what you don't know” is precisely where judgment begins.**

### ④ Do “AI agents” act? The praxeological answer

In 2024–25 “AI agent” became the word of the moment: systems that browse, place orders, write code, negotiate and call other tools on their own. They look as if they are “acting.” What does praxeology (Stage 2.1) say?
...
`,
  ...
  quiz: [
    {
      q: "On Knight's 1921 distinction, which of these is “uncertainty” rather than “risk”?",
      options: [
        "Pricing a standard auto insurance policy",
        "Forecasting tomorrow's milk sales at one store",
        "Deciding to enter a new market nobody has priced, with no precedent",
        "Estimating mortality at a given age",
      ],
      answer: 2,
      explain: "Risk has a historical distribution and is computable; uncertainty has none — not a small probability, an undefined one. Profit arises only on the uncertainty side.",
    },
    {
      q: "Which three elements of Foss and Klein's “judgment” does a tool lack?",
      options: [
        "Speed, accuracy, scale",
        "Ends, ownership, bearing the consequences",
        "Data, compute, algorithms",
        "Alertness, imitation, entry",
      ],
      answer: 1,
      explain: "Judgment = committing one's own resources to a plan under uncertainty and bearing the outcome. A tool has no ends (only a set objective), owns nothing, and cannot lose.",
    },
    {
      q: "A firm lets a model decide to enter a new market and loses $200 million. How does praxeology see “who bears it”?",
      options: [
        "The model, since it made the decision",
        "Nobody, since the decision was automated",
        "The shareholders; the firm in fact made its own judgment with a new tool — the judgment being “I trust this model”",
        "The regulator",
      ],
      answer: 2,
      explain: "Responsibility cannot be transferred to something with no resources and no ends. “Follow the model” is itself the owner's judgment.",
    },
    {
      q: "Which best describes AI's effect on Kirznerian alertness?",
      options: [
        "AI replaces alertness entirely",
        "AI greatly amplifies alertness, because alertness works on existing but unnoticed information — pattern recognition's home ground",
        "AI is unrelated to alertness",
        "AI makes alertness unimportant",
      ],
      answer: 1,
      explain: "Finding combinable items in ten thousand patents or comparing price gaps is discovering opportunities that were “already there” — AI excels. What it cannot reach is judgment about what does not yet exist.",
    },
    {
      q: "AI makes experiments cheaper and imitation faster. What is the net effect on profit?",
      options: [
        "All profits rise",
        "Profit on computable, copyable parts is competed away fast; profit concentrates in uncomputable, uncopyable judgment and bearing",
        "Profit disappears",
        "Profit transfers to model companies",
      ],
      answer: 1,
      explain: "Exactly Knight's prediction: the return to risk goes to zero and profit comes from uncertainty. AI spreads the manager's function and makes the entrepreneur's scarcer.",
    },
  ],
  ...
  further: [
    ...
    { label: "Mises, Human Action, Chapters XIV–XV — entrepreneur, manager and uncertainty", url: "https://mises.org/library/book/human-action" },
    { label: "Kirzner, Competition and Entrepreneurship (1973) — the source on alertness", url: "https://mises.org/library/book/competition-and-entrepreneurship" },
    { label: "Peter Klein, The Capitalist and the Entrepreneur (2010) — Austrian essays on judgment, ownership and the firm (Mises Institute full text)", url: "https://mises.org/library/book/capitalist-and-entrepreneur-essays-organizations-and-markets" },
    { label: "Peter G. Klein's articles on entrepreneurial judgment (Mises Institute author page)", url: "https://mises.org/profile/peter-g-klein" },
  ],
};
