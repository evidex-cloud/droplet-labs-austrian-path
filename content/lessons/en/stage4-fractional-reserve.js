...
This is “deposit money,” or in Mises's term a “money substitute” — the “second station” of the Cantillon chain in Stage 4.3, and the source of that station's power: give the banking system one dollar of reserves and it can conjure several dollars of deposits.
...
**The layer that matters most — the business cycle.** The $9,000 the banks created is not the result of anyone's saving. It enters the loan market and pushes the interest rate below where it would be if only genuine savings were available to lend. Stage 3.5 showed that the natural rate reflects people's time preference; a market rate pushed down by credit expansion **lies**: it tells entrepreneurs “society has saved more; longer projects are now affordable,” when nobody has saved an extra cent. That lie is where the business cycle begins — Stage 5.1 draws it as a single picture.
...
$$
Bank A  |  Assets: reserves 1,000   |  Liabilities: deposit (you) 1,000
$$
...
$$
Bank A  |  Assets: reserves 1,000 · loan 900   |  Liabilities: deposit (you) 1,000 · deposit (B) 900
$$
...
- **Elastic supply.** When the public's demand for money rises (the demand for cash balances of Stage 4.2), free banks can meet it by issuing more, avoiding needless deflation; a 100% system cannot.
- **Freedom of contract.** As long as depositors knowingly consent, fractional reserves are a legitimate voluntary contract.

The Rothbardian reply: Scottish “free banking” had the Bank of England as an implicit backstop; clearinghouse discipline prevents a **single** bank from over-expanding but not **all banks expanding together** (then nobody's notes flow to a rival on net); and “meeting the demand for money” conflates two ways of meeting it — falling prices meet it too (Stage 4.2). The debate is developed fully in Stage 9.4, including Hayek's position in *The Denationalisation of Money* (1976). For now, remember: **both camps oppose central banking**; they disagree about whether, without a central bank, fractional reserves would be eliminated by the market on their own. Austrians are not a monolith, a point Stage 14.3 returns to.

### ④ Bank runs: why they are discipline, and the difference between “no cash” and “no assets”

A run is an inherent possibility of fractional reserves, not an external accident. But Austrians view runs the opposite way from the mainstream: **a run is the market's discipline on an over-extended bank**, just as losses are the discipline on mistaken entrepreneurs (Stage 6.3).
...
So the textbook's mechanical story — “central bank injects reserves → the multiplier expands them” — is out of date. The more accurate description today is **“banks lend first, creating deposits, then look for reserves; the central bank steers lending through interest rates and regulation rather than the quantity of reserves”** — as the Bank of England openly acknowledged in a well-known 2014 article. What does this do to the Austrian argument? **The core is untouched — if anything, it is more direct.** Bank loans still create deposits from nothing; those deposits are still not genuine savings; they still push the market rate away from the natural rate. All that has changed is who presses the accelerator: the central bank's rate target and regulatory capital rather than the quantity of reserves. Stage 4.5 covers the central bank; Stage 9.4 asks whether free banks would restrain themselves without one; and Stage 17.5 poses a new question: under a Bitcoin standard, where reserves cannot be conjured by a central bank, would fractional-reserve banking and the business cycle still exist?

The lesson in one sentence: **fractional-reserve banks manufacture money substitutes from nothing through “loans create deposits”; this credit, which is not saving, lowers the market interest rate and makes it lie about time preference — legally it confuses custody with lending, structurally it builds in bank runs, economically it is the source of the business cycle; and Austrians still disagree about whether a free market would eliminate it on its own.** The next lesson (Stage 4.5): why this system needs a central bank as backstop, and what happened once it got one.
`,
...
`,
  ...
  quiz: [
    {
      q: "With a 10% reserve ratio you deposit $1,000 in cash. To what maximum can the banking system expand total deposits, and how much of that is created by loans?",
      options: ["$1,000; none", "$1,900; $900", "$10,000; $9,000", "$100,000; $99,000"],
      answer: 2,
      explain: "Multiplier = 1 ÷ reserve ratio = 10; deposits = 1,000 + 900 + 810 + … = 10,000. Only $1,000 was actually deposited; the other $9,000 are money substitutes manufactured by “loans create deposits.”",
    },
    {
      q: "What is the core difference between a loan (mutuum) and an irregular deposit in Huerta de Soto's analysis?",
      options: [
        "A loan pays interest; a deposit does not",
        "A loan transfers ownership and use; a deposit transfers no ownership, and the custodian must keep the full amount available at all times",
        "A loan is long-term; a deposit is short-term",
        "There is no real difference, only a difference of name",
      ],
      answer: 1,
      explain: "A demand deposit's intention is “available whenever I want it,” which is custody; fractional reserves treat the deposit as a loan so that two people claim the same money — a confusion of contracts for Huerta de Soto, a legitimate consented contract for the free bankers.",
    },
    {
      q: "A bank has deposits 10,000, reserves 1,000, loans 9,000; depositors ask for $1,500. If every loan is fully recoverable, the bank's condition is:",
      options: ["Perfectly normal, no problem at all", "In need of immediate nationalization", "Insolvent — already bankrupt", "Illiquid but solvent — given time it can pay everyone"],
      answer: 3,
      explain: "Assets (1,000 + 9,000) ≥ liabilities 10,000, but it cannot produce $1,500 of cash right now — **illiquid**. If 15% of loans were bad, assets would be 8,650 < 10,000 — **insolvent**. Only by separating the two can you tell when “liquidity support” helps and when it conceals.",
    },
    {
      q: "What is the free bankers' (Selgin/White) strongest argument against 100% reserves?",
      options: [
        "In a competitive system without a central bank, an over-issuing bank rapidly loses reserves through the clearinghouse — market discipline restrains fractional reserves, and elastic supply can meet money demand",
      ...
      answer: 0,
      explain: "Historical cases such as Scotland 1716–1845 and the clearinghouse mechanism are the free bankers' core evidence; Rothbardians reply that it cannot stop all banks expanding together, and that Scotland had the Bank of England as implicit backstop. Stage 9.4 develops this.",
    },
    {
      q: "Real savings are $1,000 and the natural rate is 5%; after banks create $9,000 of credit the market rate falls to 2%. Which consequence do Austrians regard as most important?",
      options: [
        "Savers receive more interest",
        "The market rate lies about time preference: entrepreneurs launch long projects, but nobody has saved an extra cent — the starting point of the business cycle",
        "Prices immediately rise 900%",
        "None, because long-term rates automatically revert",
      ],
      answer: 1,
      explain: "The credit-lowered rate tells entrepreneurs “society has saved more” while consumers' time preference is unchanged. Resources are pulled toward long projects and present consumption at once; the tug-of-war cannot last — Stage 5.1's ABCT begins exactly here.",
    },
  ],

  further: [
    { label: "Jesús Huerta de Soto, Money, Bank Credit, and Economic Cycles (1998/2006), full text — the legal argument and credit expansion", url: "https://mises.org/library/book/money-bank-credit-and-economic-cycles" },
    { label: "Rothbard, The Mystery of Banking (1983) — the accessible full treatment of fractional reserves and the 100% case", url: "https://mises.org/library/book/mystery-banking" },
    { label: "George Selgin, The Theory of Free Banking (1988) — the systematic free-banking statement (full text, Mises Institute)", url: "https://mises.org/library/book/theory-free-banking-money-supply-under-competitive-note-issue" },
    { label: "Lawrence H. White, “Competing Money Supplies”, Econlib Encyclopedia — a concise overview of free banking and currency competition", url: "https://www.econlib.org/library/Enc/CompetingMoneySupplies.html" },
    { label: "Bank of England, “Money creation in the modern economy” (2014) — a central bank admitting that loans create deposits", url: "https://www.bankofengland.co.uk/quarterly-bulletin/2014/q1/money-creation-in-the-modern-economy" },
  ],
};
