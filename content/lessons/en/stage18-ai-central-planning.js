...
The calculation debate has already been reborn three times: Mises versus the socialists in 1920 (Stage 7.1), Lange versus Hayek in 1936–40 (Stage 7.3), and big data in the 2010s (Stage 7.5). The fourth incarnation brings three genuinely new things, and each deserves to be stated precisely, because each **does** change the force of some part of the old argument:
...
- **Sensing.** Barcodes, RFID, phone location, point-of-sale terminals, satellite imagery. A planner no longer depends on factories reporting their output — it can “see” the shelves. The old objection that “reported data will lie” (the soft budget constraint of Stage 7.3) is half-neutralized: physical quantities can now be observed, even though what they are *worth* still cannot.
...
The heart of Hayek's argument was not “too much knowledge to compute” but “**using knowledge requires its holder to decide on the spot**, and prices let those holders coordinate without understanding the whole.” LLMs changed the cost of centralizing the first kind of knowledge, barely touched the second, and did nothing to the third. **And profit and loss in an economy come overwhelmingly from the second and third.** Stage 15.4 said “data is not knowledge.” Add one more line here: **a corpus is not action.**

A footnote that is really a demonstration. LLM “hallucination” — confident generation where there is no basis — is not a bug in this story; it is an exhibit. Asked about something outside its training distribution, a model produces **something that looks like knowledge.** A planner that allocates resources on such output is not planning; it is dreaming, and it cannot easily tell the difference. Stage 18.3 returns to this.

### ④ Novelty: preferences and products are created in action

This layer comes from Stage 6.1. It is the deepest of the three and the easiest to overlook in the AI version.
...
- **Market-augmenting**: give the model to **participants** as a tool — to discover prices faster, forecast demand more accurately at given prices, match supply and demand more cheaply, write contracts at lower cost. On this road AI is a capital good (Stage 18.2); it makes the discovery procedure of Stage 6.2 run faster and gets the local knowledge of Stage 7.2 into prices sooner. Today's dynamic pricing, demand forecasting, recommendation systems and automated market-making almost all live here.

The difference is not technical. It lies in **who owns the resources, who bears the loss, and whether prices are still being generated.** The same model placed inside a firm to schedule inventory at market prices is augmentation; placed over an economy that has abolished prices to issue orders to everyone is replacement. Stage 18.6 traces this line through algorithmic pricing and AI agents; Stage 18.3 traces it through judgment.
...
`,
  ...
  quiz: [
    {
      q: "An AI planner takes over the economy and abolishes private ownership and exchange of the means of production. On the AI version of Mises's 1920 argument, what is its most fundamental difficulty?",
      options: [
        "Not enough compute for so many equations",
        "The prices it was trained on came from exchange between owners; once exchange is abolished, new prices have nowhere to come from, leaving a table of stale ones",
        "Workers will slack off",
        "It cannot read sensor data",
      ],
      answer: 1,
      explain: "Mises's argument is about **inputs**, not compute: prices for producer goods arise only from their exchange. AI consumes prices; market-replacing AI exhausts its own input.",
    },
    {
      q: "Which kind of knowledge is hardest for a large language model to reach, yet is where market profit mostly comes from?",
      options: [
        "Articulated knowledge in textbooks and contracts",
        "Data in public financial statements",
        "Tacit, local knowledge updated daily by action, plus knowledge of products and preferences that do not yet exist",
        "Programming-language syntax",
      ],
      answer: 2,
      explain: "LLMs excel at compressing what was written down; Hayek's knowledge of time and place is mostly unwritten and constantly updated, and novelty is in no corpus until it is created.",
    },
    {
      q: "“AI makes firms plan better internally and pushes the Coasean boundary outward.” What is the precise Austrian qualification of this concession?",
      options: [
        "It shows markets can be replaced step by step",
        "Firms plan inside the outside price system; a moving boundary is not a vanishing one, and the far side must still be a market or internal planning has nothing to calculate with",
        "It holds only for small firms",
        "It has nothing to do with the calculation debate",
      ],
      answer: 1,
      explain: "Klein (1996): the limit on firm size is whether internal activities still have outside prices to refer to — exactly the input AI needs.",
    },
    {
      q: "Why do Austrians call “let AI maximize social welfare to allocate resources” the value-side version of the knowledge problem?",
      options: [
        "Because welfare data are too big to store",
        "Because ends are subjective, plural and conflicting with no uniquely correct way to sum them; any objective function is a value ruling on everyone's behalf",
        "Because AI is not smart enough",
        "Because governments would refuse",
      ],
      answer: 1,
      explain: "From Stage 0.1's subjective ends to Arrow's theorem, the question is always “whose ends?” The market's answer is not to sum; prices only convey what others would give up.",
    },
    {
      q: "Which of the following is market-augmenting rather than market-replacing AI?",
      options: [
        "Abolishing prices and having a model issue nationwide allocation orders",
        "A retailer using a model to forecast store-level demand at market prices and move inventory accordingly",
      ...
      answer: 1,
      explain: "The line is drawn by who owns the resources, who bears losses and whether prices are still being generated. Forecasting and scheduling at market prices is a participant's tool that speeds the discovery procedure.",
    },
  ],
  ...
  further: [
    ...
    { label: "Peter G. Klein, Economic Calculation and the Limits of Organization (1996) — the classic paper on firm boundaries and calculation", url: "https://mises.org/library/economic-calculation-and-limits-organization" },
    { label: "Econlib Encyclopedia: Socialism (Robert Heilbroner) — includes the calculation debate and Lange's computer claim", url: "https://www.econlib.org/library/Enc/Socialism.html" },
    { label: "Cato Institute research on artificial intelligence and economic policy", url: "https://www.cato.org/research/artificial-intelligence" },
  ],
};
