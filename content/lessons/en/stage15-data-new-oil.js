...
**First, concession.** Data really is a capital good — a record of past action which, once processed, raises the productivity of future production. That is fully consistent with Menger's higher-order goods (Stage 1.1): data's value is imputed back from the value of the final product it helps make.
...
**Third, back to calculation.** Even a firm with all the world's data faces Mises's 1920 problem (Stage 7.1): data tells you *what people did*, not *whether it was worth it*. To decide whether a logistics route should open or a data center should be built, you must reduce heterogeneous inputs to comparable numbers — prices — and prices only come from market exchange. Amazon calculates internally with market prices too; all its data did not spare it the judgment failure of the Fire Phone (2014, a write-down of about $170 million). This is what we call the **knowledge problem 2.0**: big data has not solved the calculation problem; it has only made the illusion that it has been solved more convincing. Stage 7.5 discussed Alibaba's 2017 claim that big data makes planning possible; Stage 18.1 asks the same of AI.

We also have to deal with data property and privacy (Stage 9.1): who owns “your click on a website”? Austrians have no unified answer, and regulation like GDPR, seen through the five-step method of Stage 14.1, often produces the opposite of its intent. Finally we concede: data really is moving Coase's boundaries of the firm (Stage 9.2) — some firms are bigger for genuine efficiency reasons.
...
3. **Data has network effects.** More users → more data → better models → better products → more users. This is the indirect network effect of Stage 15.1 with “data” inserted as the middle link.
...
The argument has a core Austrians accept entirely: **data is a capital good** — a record of past action that, processed, raises the productivity of future production, with value imputed from the final product it helps make (Stage 1.1). What Austrians reject is each step of the inference from “capital good” to “new oil” to “inevitable concentration.” We take them in turn.

### ② Data ≠ information ≠ knowledge: Hayek's three distinctions

When Stage 7.2 covered Hayek's 1945 essay, the emphasis was on “knowledge is dispersed.” This lesson uses a deeper layer of the same essay: **there are different kinds of knowledge, and the most important kind is not data.**
...
Hayek's “knowledge of the particular circumstances of time and place” and Michael Polanyi's “tacit knowledge” (Stage 7.2: what you know but cannot say) both belong to the third layer, and they have three features that make them **in principle** impossible to load into a database:
...
Now apply the tools of Stage 3.4 to “data is a capital good.” Lachmann's capital theory has two key words: **heterogeneity** (capital is not a homogeneous lump of “K”; each item has limited uses) and **complementarity** (an item's value depends on what other capital it can work with). Data is the textbook case of both:
...
- **Data's value is imputed from its use.** Menger's imputation (Stage 1.1) applies word for word: a datum is worth whatever the final product it helps make is worth — and consumers decide that. Google's search data is valuable because advertisers pay for search ads; if people stopped searching tomorrow (and asked an AI instead), the same data would lose much of its value. **Data has no “intrinsic” value, just as oil had none before the internal-combustion engine.**
...
If data is a capital good, who owns it? This is a genuine hard case for the property theory of Stage 9.1, and Austrians have no single answer.
...
Candidly: **the Austrian theory of data property is incomplete.** Property theory rests on scarcity and conflict (Stage 9.1), while data is copyable and non-rival with only “de facto exclusivity in use” — it sits between scarce goods and ideas (the intellectual-property question of Stage 15.3), and neither theory fits it fully. An open problem for Stage ∞.1.

An incomplete theory does not prevent examining a specific law with the five-step method of Stage 14.1. The EU's General Data Protection Regulation (GDPR, in force May 2018):
...
4. **How do incentives change?** Giants gain a reason to lobby for stricter rules (the “raising rivals' costs” of Stage 15.2); startups route around Europe.
...
Coase asked in 1937: if markets are so good, why do firms exist? The answer is **transaction costs**: some things are cheaper to direct inside a firm than to negotiate on the market again and again. The firm's boundary lies where “the cost of internal direction = the cost of market transaction” (Stage 9.2 covered Coase). Data lowers both costs, but by different amounts:

- Where **internal coordination costs fall more**, firms grow. Amazon's logistics network is the example: real-time inventory, route optimization and demand forecasting make “do your own warehousing and delivery” cheaper than “outsource to dozens of carriers” — not a network effect but **real operating efficiency**, which Austrians should recognize as market-earned scale (Stage 6.4). Walmart did the same with data-driven supply chains in the 1990s.
- Where **market transaction costs fall more**, firms shrink. Platforms let an individual take jobs without joining any company (ride-hailing, freelance marketplaces, the creator economy of Stage 16.3) — here data dismantles firms rather than entrenching them.
...
`,
  ...
  quiz: [
    {
      q: "Zillow had decades of housing data and valuation models, yet shut its house-flipping business in 2021. What does this best illustrate?",
      options: [
        "Data has no value",
        "Data is a record of the past, not judgment about the present; repurposing data gathered for “displaying valuations” to “buying houses with real money” needed entirely different complements and local knowledge",
        "House prices are unpredictable, so agents cannot work either",
        "Zillow did not have enough data",
      ],
      answer: 1,
      explain: "Hayek's “knowledge of time and place” meets Lachmann's “heterogeneous, specific capital”: data is a capital good but cannot be repurposed at will, and the tacit knowledge needed to judge an individual house does not fit in a database.",
    },
    {
      q: "By Hayek's distinctions, which of the following is “knowledge” rather than “data” or “information”?",
      options: [
        "User 4471 clicked product A at 14:07",
        "38% of users who click A then buy B",
        "These users are buying B because an influencer recommended it last week and the fad will fade next week",
        "The server logs total 10 TB",
      ],
      answer: 2,
      explain: "The first two are data and information (organized data). The third is an interpretation of the present that depends on context and judgment about novelty — “knowledge of time and place,” and exactly where profit comes from.",
    },
    {
      q: "Why has big data “not solved the calculation problem”?",
      options: [
        "Because storage is too expensive",
        "Because data answers “what people did,” while judging whether a production plan is worthwhile requires comparing the relative scarcity of inputs, which only market prices can do; and data itself is a record of choices made at real prices",
        "Because big-data firms refuse to share data",
        "Because computers are too slow",
      ],
      answer: 1,
      explain: "This is Mises's 1920 argument in contemporary form: Amazon accounts internally at market prices; switch off the price system and data goes stale from day one. Stage 18.1 asks the same of AI.",
    },
    {
      q: "Through the five-step method, what is the “unseen consequence” of GDPR that Austrians point to?",
      options: [
        "Users gained complete control over their data",
        "Compliance is a fixed cost, trivial for giants and existential for small firms; research found fewer ad-tech vendors and share concentrating in the largest — the law entrenched what it meant to constrain",
        "The European internet got faster",
        "The giants went bankrupt from fines",
      ],
      answer: 1,
      explain: "A case of the “raising rivals' costs” of Stage 8.3 and the state moat of Stage 15.2: intended to constrain the giants, it entrenched them, because compliance is a fixed cost.",
    },
    {
      q: "What should Austrians concede that data has “really” changed?",
      options: [
        "Data has made prices unnecessary",
        "Data lowers both internal coordination costs and market transaction costs, so it creates both bigger firms (Amazon logistics) and smaller ones (freelancers on platforms) — Coase's boundary of the firm moves in both directions",
        "Data has proven central planning feasible",
        "Data makes all firms smaller",
      ],
      answer: 1,
      explain: "Coase's 1937 boundary is set by comparing two transaction costs. Data lowers both; the direction differs by industry and must be discovered by the market process — “data leads to concentration” is at best incomplete.",
    },
  ],

  further: [
    { label: "Hayek, “The Use of Knowledge in Society” (1945) — the original source of the distinctions among kinds of knowledge (Econlib)", url: "https://www.econlib.org/library/Essays/hykKnw.html" },
    { label: "Mises, “Economic Calculation in the Socialist Commonwealth” (1920) — the original calculation argument (Mises Institute)", url: "https://mises.org/library/book/economic-calculation-socialist-commonwealth" },
    { label: "Lachmann, Capital and Its Structure (1956) — heterogeneity and complementarity of capital (Mises Institute)", url: "https://mises.org/library/book/capital-and-its-structure" },
    { label: "Rothbard, The Ethics of Liberty, Ch. 16 “Knowledge, True and False” — privacy and property rights (Mises Institute)", url: "https://mises.org/library/book/ethics-liberty" },
    { label: "The Economist, “The world's most valuable resource is no longer oil, but data” (May 2017) — the opposing case in its own words", url: "https://www.economist.com/leaders/2017/05/06/the-worlds-most-valuable-resource-is-no-longer-oil-but-data" },
  ],
};
