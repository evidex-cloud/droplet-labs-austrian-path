export default {
  ...
  stage: 15,
  order: 2,
  title: "Platforms, Two-Sided Markets & 'Winner-Take-All': The Monopoly Charge Revisited",
  difficulty: "newera",
  prereqs: ["network-effects", "monopoly-question"],

  oneLiner:
    "Google handles about nine in ten searches, Apple takes up to 30% in its App Store, Meta bought Instagram and WhatsApp, Amazon is both the marketplace and a seller in it — and for a decade antitrust agencies everywhere have been suing platforms. The theory behind the charge: **network effects make platforms winner-take-all, a winner cannot be dislodged, therefore competition is dead.** This lesson steelmans two-sided-market theory and the cases, then brings in the tools of Stages 6.2 and 6.4: competition is a process not a state, consumer sovereignty is the only test, and the list of “unassailable” networks that fell is long. Then it names what Austrians **should** worry about — not size, but **moats dug by the state**: intellectual property, regulatory capture, licensing, and the rules platforms lobby for that conveniently raise their rivals' costs.",

  intuition: `
Start with some pricing that looks illogical. A free newspaper: readers pay nothing, advertisers pay everything. A credit card: the cardholder pays nothing and gets cash back, the merchant pays 2–3% per transaction. An app store: users download for free, developers hand over up to 30%. A ride-hailing platform: early riders get discounts, early drivers get bonuses, and the platform loses money. If you apply the Stage 1.3 template — one good, one group of buyers, one group of sellers — every one of these prices is wrong: whoever uses more should pay more.

In 2003 Jean Tirole and Jean-Charles Rochet gave this pricing a name: the **two-sided market.** A platform is not selling a good; it is matching two groups who need each other. Its pricing problem is not “how much to charge” but “**which side to charge**” — because the more people on one side, the more the other side wants to come. Charge little or nothing to the price-sensitive side, charge the side that gains most from the other's presence, and the network turns. This is the commercial form of the indirect network effect of Stage 15.1, and a good part of Tirole's 2014 Nobel was awarded for it.
...
What do Austrians say? First, what they do **not** say: not that big firms are always innocent, not that the market always self-corrects, and not that network effects fail to raise entry barriers — Stage 15.1 just conceded that they do. Austrians say three more specific things.

**First, get the test right.** Stage 6.4 taught that share, size and margins are not evidence of monopoly; the only tests are **whether consumers are being served better** (the consumer sovereignty of Stage 6.3) and **whether the door to entry has been locked by law.** Measured with that ruler, many winner-take-all charges deform: a “monopolist” that cuts its price to zero every year and keeps adding features is a very odd monopolist.

**Second, read the whole history.** “Network effects make it unassailable” was said of MySpace, Nokia, BlackBerry, Internet Explorer and Yahoo — every one of which fell, and fell fast. That is not coincidence; it is the **competition-as-process** of Stage 6.2: a leader's position has to be won again every day.

**Third, worry about the right thing.** Austrians do worry about one kind of moat — the kind **dug by the state.** Patents and copyrights, thousand-page compliance regimes, industries you need a license to enter, and the rules platforms themselves lobby for — “for safety,” “for privacy” — that happen to be unaffordable for smaller rivals (Stage 8.3). Such moats are not maintained by consumers' votes and are not washed away by better products. Antitrust agencies rarely sue over them, because they are dug by the same system the agencies belong to.
...
Stage 6.4's definition: monopoly = a state-granted exclusive privilege. Apply that definition to the platform economy and several real moats appear:

- **Intellectual property.** Patents and copyrights are legally granted exclusive rights (Stage 9.1 covered the disagreement among Austrians about them). Platforms' core algorithms, interfaces, even “one-click ordering” have been patent-protected; for a would-be maker of a compatible product, the first barrier is often not engineering but legal fees.
- **Compliance costs.** The EU's General Data Protection Regulation (GDPR, in force 2018) runs to hundreds of pages; compliance is a rounding error for Google and a matter of life and death for a twenty-person startup. Some studies find that concentration in Europe's ad-tech market **rose** after GDPR took effect — the biggest beneficiaries were exactly the firms it targeted. Stage 15.4 re-examines this with the five-step method.
- **Licensing.** Taxi medallions protected cab companies for decades (the Stage 6.4 case); today's payment licenses, banking charters, content licenses and proposed “safety licenses” for AI models all turn entry into something you apply to the state for.
...
**Third, “kill zone” acquisitions.** Kamepalli, Rajan and Zingales argued in a 2020 paper that when a giant can acquire or clone any new rival, venture capital avoids the tracks “too close to the giant,” so many competitors that would have existed are never born. That is an **unseen** loss (Stage 1.4), the kind Austrians are usually best at seeing. The Austrian reply has two layers: acquisitions are often a founder's only exit, so banning them reduces startup formation; and cloning is itself competition. Yet Austrians genuinely lack a theory of **how far potential competitors are deterred** — Kirzner's alertness is about seeing an opportunity, not about seeing it and standing down because a giant is present.

**Where Austrian theory needs development** can be listed directly: (1) a theory of when **contractual barriers** (default contracts, exclusivity deals) become equivalent to state barriers; (2) a statement about the **time scale of the process** — “it will eventually be replaced” is not an answer for today's consumers; (3) a formal place for **multi-homing cost** in competition theory — it may deserve to replace “share” as the indicator of whether a platform market is contestable. All three are open problems for Stage ∞.1.

The lesson in one sentence: **a two-sided market's price structure is discovered by entrepreneurs, not evidence of monopoly; “unassailable” networks never really were, switching costs are subjective, multi-homing is normal and consumer sovereignty is the only test; the moats Austrians should fear are the ones granted by the state and lobbied for by incumbents; and on data moats, bought defaults and kill zones, Austrians need theory rather than slogans.** Stage 16.4 asks how platforms as private property may govern speech; Stage 17.3 shows what happens to this analysis when platforms start issuing money (stablecoins).
`,
...
`,
  ...
  quiz: [
    {
      q: "What is the core insight of Rochet–Tirole two-sided-market theory?",
      options: [
        "Platforms should charge both sides the same price",
        "In a two-sided market the price structure (which side pays) matters as much as the price level, because one side's numbers decide whether the other side comes",
        "Platform prices should equal marginal cost",
        "All platform profit comes from network effects",
      ],
      answer: 1,
      explain: "Move the same total price from “half each” to “one side free, the other pays all” and transaction volume can change completely. Discovering that structure is the platform's entrepreneurial job.",
    },
    {
      q: "What was the heart of the DOJ's case against Google Search (filed 2020, first-instance ruling 2024)?",
      options: [
        "Google's search share was too large",
        "Google charged too much",
        "Google paid enormous sums to buy the “default search engine” slot, locking up distribution by contract",
        "Google acquired too many rivals",
      ],
      answer: 2,
      explain: "The case turned on exclusive default contracts (court documents put 2021 payments at about $26 billion), not on share itself. It is also the “contractual barrier” problem where Austrians admit their theory needs work.",
    },
    {
      q: "Which of the following is a platform moat Austrians think one should **really** worry about?",
      options: [
        "The platform has too many users",
        "The platform is free on one side",
        "Compliance rules the incumbent lobbied for that happen to be unaffordable for small rivals",
        "The platform's product is better than its rivals'",
      ],
      answer: 2,
      explain: "This is the “raising rivals' costs” strategy (Salop and Scheffman 1983) combined with public choice: concentrated benefits, dispersed costs, and once the rule passes a market-won position is cemented by law — monopoly in the Austrian sense.",
    },
    {
      q: "Why is multi-homing cost the key variable for whether a platform market can tip again?",
      options: [
        "Because it determines the platform's margin",
        "Because when multi-homing is cheap, users and merchants can try a new platform without abandoning the old one, largely dissolving the entrant's cold-start problem",
        "Because antitrust law bans multi-homing",
        "Because it has nothing to do with network effects",
      ],
      answer: 1,
      explain: "Drivers running Uber and Lyft together, sellers on Amazon and Shopify at once, turn “winner-take-all” into “winner-takes-a-bit-more” — the entrant no longer has to cross the Stage 15.1 tipping point first.",
    },
    {
      q: "What is the limitation of the Austrian reply to “data moats”?",
      options: [
        "Austrians deny that data has value",
        "The reply explains why a data moat is not permanent but not how long it lasts — and “how long” matters to consumers kept outside",
        "Austrians think data moats are created by government",
        "Austrians have no reply at all",
      ],
      answer: 1,
      explain: "Stage 15.4 shows data is not knowledge and that the firm with the most data can still stumble; but “it will eventually be replaced” is not an answer for today's consumers. That is where Austrians need a theory of the process's time scale.",
    },
  ],

  further: [
    { label: "Rochet & Tirole, “Platform Competition in Two-Sided Markets” (JEEA 2003) — the founding paper of two-sided-market theory", url: "https://academic.oup.com/jeea/article/1/4/990/2280902" },
    { label: "Hayek, “The Meaning of Competition” (1946) — competition as a process (Mises Institute)", url: "https://mises.org/library/book/individualism-and-economic-order" },
    { label: "Dominick Armentano, Antitrust and Monopoly (1982) — the case-by-case record of antitrust (Mises Institute)", url: "https://mises.org/library/book/antitrust-and-monopoly-anatomy-policy-failure" },
    { label: "Thomas DiLorenzo, “The Origins of Antitrust: An Interest-Group Perspective” (1985) — antitrust law itself as rent-seeking", url: "https://mises.org/library/origins-antitrust-interest-group-perspective" },
    { label: "Liebowitz & Margolis, Winners, Losers & Microsoft (1999) — the evidence on leadership changes in software markets", url: "https://www.utdallas.edu/~liebowit/book/book.html" },
  ],
};
