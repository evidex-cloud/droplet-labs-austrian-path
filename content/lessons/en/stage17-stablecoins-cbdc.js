...
Hayek's 1976 scheme (Stage 9.4, block ①) had three elements: private issue, free choice, and issuers competing on **stable purchasing power.** He imagined the issuers would be banks, each with its own “ducat” or “Swiss note,” with dozens of units of account circulating at once.
...
In Mises's taxonomy (Stages 4.2 and 4.4), a stablecoin is a **money substitute**: a claim on a money (the dollar) that people regard as redeemable at par on demand. Whether it keeps that status depends on the credibility of the redemption promise — which brings us to block ②.

### ② Are they fractional? Reserve composition, attestations, and the March 2023 USDC depeg

Stage 4.4 sorted banks into two kinds: **warehouses** (100% reserves, fees for safekeeping) and **fractional-reserve banks** (lend out deposits, earn a spread, bear run risk). Which are stablecoins? The answer: **it depends on how you count “reserves,” and it differs from coin to coin.**
...
The next 48 hours were a pure bank run, checkable line by line against Stage 4.4:
...
3. On 11 March USDC traded on exchanges at about $0.87–0.88. Note: **8% exposure, 12% price drop.** What is the extra 4%? The expectation of “will others run before me” — the reflexivity of Stage 16.5, or simply the definition of a run: **even when assets suffice, if redemption cannot be immediate, people price being at the back of the queue.**
...
The Austrian reading has two layers. The first is a victory: **currency competition really does discipline bad money** — the central banks of Argentina and Nigeria have effectively lost their monopoly over their citizens' demand for money, and Mises's “flight into real values” (the prelude to the crack-up boom of Stage 4.3) now has a more convenient exit: flight into digital dollars. The second is a warning: **people fled to the dollar, not to gold or Bitcoin.** They wanted a familiar unit of account with predictable near-term purchasing power. That does not refute Austrian theory — Menger's saleableness theory predicts exactly this — but it does refute the “hard money must win” narrative of Stage 17.2.

### ⑥ What the market chose: the free-banking and 100%-reserve readings of stablecoins

Bring back the two camps of Stage 9.4 and let each read the decade's evidence.
...
4. Issuer-less money (Bitcoin) has not won the payments competition, though it holds a place in the store-of-value competition (Stage 17.1).
5. A CBDC is the one technology that makes every intervention of Stage 8.4 enforceable at zero cost. Austrian opposition here is more unanimous than any of its disagreements about stablecoins.

Stage 17.4 places DAI-style “notes without an issuing company” and Terra's failure inside the smart-contract framework; Stage 17.5 asks whether custodians could still generate cycles if the base money were Bitcoin rather than the dollar. This lesson is not investment advice.
`,
...
`,
  ...
  misconceptions: [
    ...
    "**“A CBDC is just digital cash; Austrians who oppose it are opposing technology.”** — The objection is not to “digital” but to “programmable”: usage restrictions, expiry dates, negative rates, real-time tracing, turning money from a rule applying equally to all into a command aimed at particular people (Stage 7.4). Bitcoin is digital too, and nobody can program it.",
    "**“The GENIUS Act's 100%-reserve rule proves the Austrians won.”** — The 100% clause does match Rothbard, but the same law exempts bank deposits, creating a two-track system; the “no interest” clause is a rent-seeking product of bank lobbying (Stage 8.3) that guts the competitive mechanism by which issuers would pass reserve income to users; and “reserves = Treasuries” makes stablecoins a deficit-financing channel.",
    "**“Currency competition will end with hard money (gold or Bitcoin) winning.”** — The evidence so far points the other way: where currency competition really happens — Argentina, Turkey, Nigeria — people flee to digital dollars. The unit of account is the strongest network good (Stage 15.1); familiarity and predictable near-term purchasing power beat hardness. That does not refute Austrian theory, but it does refute the “hardest must win” narrative.",
  ],

  quiz: [
    {
      q: "In March 2023 USDC fell to about $0.87 while its exposure to Silicon Valley Bank was only about 8%. What best explains the extra drop?",
      options: [
        "Circle concealed larger losses",
        "When redemption cannot be immediate, holders price being at the back of the queue — the definition of a run",
        "US Treasuries defaulted",
        "Stablecoins never had reserves",
      ],
      answer: 1,
      explain: "This is the run logic of Stage 4.4: even with sufficient assets, if redemption at par is not instantaneous, people pay to avoid being last. Once the government backstopped SVB on Monday, the price snapped back to $1.",
    },
    {
      q: "From an Austrian standpoint, the most accurate characterization of the GENIUS Act's “no interest to holders” clause is?",
      options: [
        "Prudential regulation preventing stablecoins from becoming investments",
        "Protection of holders from interest-rate risk",
        "A rent-seeking clause won by bank lobbying, designed to keep stablecoins from competing with bank deposits",
        "A concession to CBDCs",
      ],
      answer: 2,
      explain: "A fully reserved stablecoin that shared Treasury interest would drain banks' demand deposits; banning interest in the name of “payment instruments” protects incumbents — a textbook case for Stage 8.3.",
    },
    {
      q: "What is the core Austrian objection to CBDCs?",
      options: [
        "Digital money is less secure than paper",
        "A CBDC is programmable (usage limits, expiry, negative rates) and traceable, turning money from a rule applying equally to all into a command aimed at specific people",
        "CBDCs cause deflation",
        "CBDCs would devalue Bitcoin",
      ],
      answer: 1,
      explain: "Rules vs commands (Stage 7.4), the economics of the state (Stage 8.4), the demand for money (Stage 4.2): the problem is not “digital” but “who can program it.”",
    },
    {
      q: "As of 2025, what has real-world currency competition (Argentina, Turkey, Nigeria) revealed as “the market's choice”?",
      options: [
        "Gold tokens",
        "Bitcoin as unit of account",
        "The domestic central bank's CBDC",
        "Privately issued dollar-pegged stablecoins",
      ],
      answer: 3,
      explain: "People fled to digital dollars; Nigeria's eNaira saw minimal adoption. The unit-of-account network effect let familiarity beat hardness — an honest finding Austrians must record.",
    },
    {
      q: "What do the free-banking and 100%-reserve camps each emphasize in reading the stablecoin decade?",
      options: [
        "Both think stablecoins should be banned",
        "Free bankers stress that market clearing discipline works (rising transparency, bad issuers eliminated) and oppose the interest ban; the 100% camp stresses that only final-asset reserves are safe and that Treasury reserves merely swap debtors",
        "Free bankers support CBDCs, the 100% camp opposes them",
        "Both regard Terra's algorithmic stablecoin as the right direction",
      ],
      answer: 1,
      explain: "Both readings are right, and both camps face the same facts: the market chose the dollar unit, private money is financing the government, and CBDCs are what both unanimously oppose.",
    },
  ],

  further: [
    { label: "Hayek, Denationalisation of Money (1976) — the original currency-competition proposal (IEA full text)", url: "https://iea.org.uk/publications/research/denationalisation-of-money" },
    { label: "Lawrence H. White, “Should We Fear Stablecoins?” (Cato Institute) — a free-banking analysis of stablecoins", url: "https://www.cato.org/blog/should-we-fear-stablecoins" },
    { label: "George Selgin, “Central Bank Digital Currency as a Potential Source of Financial Instability” (Cato Journal, 2021)", url: "https://www.cato.org/cato-journal/spring/summer-2021/central-bank-digital-currency-potential-source-financial-instability" },
    { label: "Mises, The Theory of Money and Credit — the original taxonomy of money substitutes and fiduciary media", url: "https://mises.org/library/book/theory-money-and-credit" },
    { label: "Selgin & White, “How Would the Invisible Hand Handle Money?” Journal of Economic Literature (1994) — the free-banking survey", url: "https://www.jstor.org/stable/2728792" },
  ],
};
