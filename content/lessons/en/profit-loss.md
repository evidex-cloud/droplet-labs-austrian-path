...
# Profit & Loss: The Market's Feedback System & Consumer Sovereignty
...
Now the opposite. A bakery makes a fortune. The neighbors say: the owner is gouging us. But consider where the money came from. He first paid for flour, hired workers, rented premises, borrowed capital — **and those prices were set by his bidding against everyone else who wanted flour, workers and premises** ([[price-formation|Stage 1.3]]). He paid $900, made bread, and the neighbors willingly handed over $1,200. The extra $300 is the neighbors saying: “you put these resources to a better use than anyone else thought of.”

That is the core of Mises's famous 1951 essay: **profit and loss are not moral concepts; they are information.** They are the grades consumers assign, after the fact, to every entrepreneurial judgment ([[entrepreneur-alertness|Stage 6.1]]). High scorers receive more resources to keep judging with; low scorers have resources taken away. The entire market relies on this one feedback system to push millions of resources continually toward the uses consumers want most — with nobody planning from the center, and no need for anyone to. [[mises-1920|Stage 7.1]] shows that once this feedback system is removed (no private property, no market prices), a planner with the best intentions in the world cannot tell whether he is creating value or destroying it.
...
This lesson also has to be candid: there is a kind of profit that **does not** come from serving consumers — money earned by using tariffs, licenses, subsidies or regulation to keep competitors out (the state barriers of [[competition-process|Stage 6.2]], the logic of intervention of [[intervention-logic|Stage 8.1]]). Austrians do not defend all profit, only **profit won under free entry by consumers' votes.** Telling the two apart is a tool the second half of this course ([[intervention-logic|Stages 8]] and 15) uses again and again.
...
- **The entrepreneur is not the master but a servant who can be dismissed at any time.** However large a company, if consumers stop buying tomorrow it starts bleeding just like the baker in Case B. A big company's “power” is delegated, not owned — that is the story of Blockbuster, Nokia and Kodak in [[creative-destruction|Stage 15.5]].
- **The vote is unequal: those with more money have more ballots.** Austrians do not dodge this. Mises's answer is that (on a free market) the money of the rich was itself won in past plebiscites — each of their dollars is a vote consumers cast for them earlier; and every dollar the rich spend can, in the end, go only to **things consumers are willing to buy** — in other words, it flows back into the plebiscite. Whether the starting positions were fair is a different question (the origin of property, [[why-property|Stage 9.1]]), not a question about the profit mechanism itself.
...
**The boundary of the category error.** This argument holds only under **free entry.** If a company's profit comes from a tariff that shuts out foreign rivals, a license that shuts out new entrants, a subsidy paid by taxpayers, or regulation that small competitors cannot survive — then it really can “make money from greed” without serving anyone. In Austrian vocabulary that income is not profit but **rent-seeking** ([[taxes-regulation|Stages 8.3]], 8.4). So the Austrian position is not “corporations are always innocent” but: **look at the source of the profit first, then decide which word to use.**
...
- **There is no answer key.** The examiners (consumers) do not themselves know what they will want next year; they only say “I like this one” when they see the paper. So students cannot memorize — they can only guess. That is the judgment of [[entrepreneur-alertness|Stage 6.1]].
- **Last term's full marks do not carry over.** Get one question right and tomorrow everyone copies your answer (the imitation of [[competition-process|Stage 6.2]]), so that question stops scoring. To keep scoring you must keep answering new questions — profit tends to zero.
...
Keep this picture: [[intervention-logic|Stage 8.1]] shows what happens when the governors start interfering with the grading; [[zero-marginal-cost|Stage 15.3]] shows how scores work when “paper and pens” become code with zero marginal cost; [[attention-economy|Stage 16.1]] shows who harvests the examiners' attention when attention itself becomes the scarcest thing.
...
## @quiz
1. A baker spends $300 on flour, $400 on labor, $100 on rent and $100 on interest to make 1,000 loaves, and sells them all at $1.20. On Mises's definition, what is his entrepreneurial profit?
   - [ ] $1,200
   - [ ] $400 (revenue minus factor costs; interest is not a cost)
   - [x] $300 (revenue minus all costs including interest)
   - [ ] $0 (profit is always zero in the long run)
   > Interest is the return to the capitalist's hat and belongs in cost. 1,200 − (300+400+100+100) = **$300** — consumers' after-the-fact grade on the baker's judgment: he turned resources the market valued at $900 into something consumers value at $1,200.

2. Same bakery, but consumers will pay only $0.80 a loaf, for a loss of $100. What does that $100 loss “say”?
   - [ ] The baker had bad luck
   - [x] These $900 of resources could have produced at least $900 of value elsewhere and produced only $800 here — the market demands them back
   - [ ] Consumers are irrational
   - [ ] The government should subsidize the bakery
   > Factor prices come from their uses elsewhere. A loss means **$100 of value was destroyed**, and the loss automatically leaves the baker unable to afford factors — the market's only correction mechanism that needs nobody's approval.

3. Why does Mises say entrepreneurial profit is “essentially temporary”?
   - [ ] Because governments tax it away
   - [x] Because imitators push the selling price down while bidding for the same factors pushes costs up, squeezing profit toward zero from both ends
   - [ ] Because consumer preferences change randomly every day
   - [ ] Because entrepreneurs spend all their profits
   > Profit rewards “seeing it before others,” and “before” is erased by time: bread drifts down from $1.20 while flour and labor rise from 700 to 860, and after a few rounds the residual is gone. This is the market being pulled toward the evenly rotating economy.

4. “Greedy corporations made a fortune out of greed.” Why do Austrians call this a category error on a market with free entry?
   - [ ] Because corporations cannot be greedy
   - [x] Because the only way greed can cash out is by getting others to pay voluntarily, and people pay only for what they want more — “served consumers” must come in between
   - [ ] Because profit is always zero
   - [ ] Because consumers never make mistakes
   > Motives do not generate income; service does. But note the boundary: when tariffs, licenses or subsidies keep competitors out, profit can bypass serving consumers — that is **rent-seeking**, which Austrians do not defend.

5. What was the core of Hayek's 1961 reply to Galbraith's “dependence effect”?
   - [ ] Advertising is a tiny share of GDP and can be ignored
   - [x] Almost all human wants (including the taste for music and science) are shaped by the environment; “shaped” does not imply “does not count”
   - [ ] Galbraith's data were wrong
   - [ ] Consumers should be banned from watching advertisements
   > That is the “non sequitur” in Hayek's title: from “the want is not innate” you cannot infer “satisfying it adds no welfare.” Otherwise Galbraith needs a list of “genuine wants” — and only he can write it.

## @further
- [Mises, “Profit and Loss” (1951) — full text (Mises Institute)](https://mises.org/library/book/profit-and-loss)
- [Mises, Human Action, Chapter XV, “The Market” — consumer sovereignty and the entrepreneurial function](https://mises.org/library/book/human-action)
- [Hayek, “The Non Sequitur of the ‘Dependence Effect’,” Southern Economic Journal (1961) — the reply to Galbraith](https://www.jstor.org/stable/1055533)
- [Kirzner, “Advertising,” The Freeman (1972) — advertising as part of the discovery procedure (FEE)](https://fee.org/articles/advertising/)
- [Econlib Concise Encyclopedia: Profits](https://www.econlib.org/library/Enc/Profits.html)
