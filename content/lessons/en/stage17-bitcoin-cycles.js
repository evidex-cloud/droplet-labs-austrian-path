...
Break the mechanism of Stage 5.1 into four necessary links and ask of each: “does it still exist under a Bitcoin standard?”
...
- These institutions were fractional-reserve banks in the sense of Stage 4.4 (Celsius, BlockFi) or outright misappropriators (FTX). The “paper bitcoin” they issued was Mises's fiduciary media.
- Their expansion depressed crypto lending rates and fed roundabout positions of the Three Arrows type that “survive only on cheap borrowing” — the malinvestment of Stage 5.2.
- Rising rates (the Fed from March 2022) and a reversal of confidence exposed the malinvestments — the liquidation of Stage 5.3.
...
- Afterwards the industry came under pressure to publish **proof of reserves**: several exchanges disclosed on-chain holdings for users to verify. It has limits (it proves assets, not liabilities), but it is the embryo of the “clearinghouse constraint” of the free-banking system in Stage 9.4 — the market invented its own audit without a regulator.
...
“Paper bitcoin” is not a slur; it is just the Bitcoin version of the “money substitutes” of Stage 4.4. Three kinds, of different hardness:
...
**Spot ETFs.** The spot ETFs approved in the US in January 2024 are required to hold real bitcoin with a custodian (mainly Coinbase) and may not lend it. **From a reserve standpoint, an ETF is a 100% warehouse** — harder than most exchanges. What it brings is not credit expansion but something else: **holders cannot withdraw coins.** You hold fund shares, convertible to dollars, not to on-chain bitcoin. That converts part of Bitcoin's demand into “dollar-denominated exposure demand,” strengthening the “monetary asset” character of Stage 17.1 and weakening the “money” character.

**Futures and perpetuals.** CME bitcoin futures (since 2017) settle in dollars and involve no bitcoin at all; crypto exchanges' perpetual contracts allow leverage of tens of times. These are not claims on bitcoin but bets on its **price.** They create no paper bitcoin, but they were the main battlefield of 2021's leverage and 2022's liquidations — the financial-market reflexivity of Stage 10.3, amplified.
...
Stage 9.4 set out the free bankers' core argument: in a competitive banking system without a central bank, an over-issuing bank is presented for redemption at the **clearinghouse** by rival banks and forced to contract; a run is a punishment for imprudence, not a systemic catastrophe — Scotland in 1716–1845 and Canada in the 1930s (no central bank, not a single bank failure) are the evidence. The 100% camp replies: better still not to permit fractional reserves at all.
...
**Halving-driven (the hard-money version).** Each halving (2012, 2016, 2020, 2024) is followed by a peak some 12–18 months later, because new supply halves, demand is unchanged, and the price rises. Problems: the halving is fully anticipated (Stage 17.2, block ②), so a rational market should price it in advance; and with only three or four observations, any four-year rhythm can be fitted.
...
1. **The second route (borrowing) remains.** Governments can still issue debt, but at market rates and out of real saving. Wars can still be fought, but every expenditure shows up immediately in rates and taxes — citizens can “see” the price of war. Stage 1.4's “unseen” becomes seen.
...
Stage 18.5 applies exactly the same method — find the credit side, find the maturity mismatch, find the malinvestment — to the AI capital-spending frenzy. This lesson and all of Stage 17 are not investment advice.
`,
...
`,
  ...
  quiz: [
    {
      q: "According to ABCT, what is the necessary condition for a business cycle under a Bitcoin standard?",
      options: [
        "A change to Bitcoin's supply cap",
        "Custodians lending depositors' coins while promising withdrawal on demand, thereby creating claims in excess of base money (fiduciary media)",
        "A government declaring Bitcoin legal tender",
        "A fall in mining hashpower",
      ],
      answer: 1,
      explain: "The cycle engine is credit expansion (Mises's “fiduciary media”), not base-money issuance. A fixed base layer cannot stop the claims layer inflating — as Celsius and others showed in 2022.",
    },
    {
      q: "What is the key structural difference between FTX and Celsius?",
      options: [
        "FTX was fully reserved, Celsius fractional",
        "Celsius was fractional-reserve lending (a yield platform); FTX diverted customer assets to an affiliate (misappropriation) and used its own token as “reserve”",
        "Both were Lightning nodes",
        "FTX had a lender of last resort, Celsius did not",
      ],
      answer: 1,
      explain: "Celsius's ailments were maturity mismatch + fractional reserves + risky assets; FTX's core was misappropriation of customer funds, with its affiliate Alameda holding FTX's own FTT as its main asset — structurally the same as Terra using LUNA as reserve.",
    },
    {
      q: "What is the free bankers' testable prediction about cycles under a Bitcoin standard?",
      options: [
        "Cycles would be longer and larger because there is no central bank to manage them",
        "Cycles would disappear entirely",
        "With no lender of last resort and no reserve top-ups, runs become discipline; cycles are shorter and smaller and losses are borne by participants",
        "Cycles would be determined solely by halvings",
      ],
      answer: 2,
      explain: "The clearinghouse-constraint logic of Stage 9.4 carried over to Bitcoin: bad institutions are liquidated fast and not rescued. The 2022 evidence is consistent, but coincided with Fed hikes and was small, so not yet sufficient.",
    },
    {
      q: "From a reserve standpoint, what is a spot Bitcoin ETF?",
      options: [
        "Fractional-reserve custody creating excess paper bitcoin",
        "A 100%-reserve warehouse (holds real bitcoin, may not lend it), but holders cannot withdraw coins, which strengthens the “monetary asset” rather than “money” character",
        "A kind of Lightning channel",
        "An algorithmic stablecoin",
      ],
      answer: 1,
      explain: "ETF rules require full holding and no lending, so it is not credit expansion; its effect is to convert demand into dollar-denominated exposure demand — the “held, not used” of Stage 17.1.",
    },
    {
      q: "Why do Austrians insist on explaining Bitcoin's four-year cycle from the “credit side” first?",
      options: [
        "Because halvings do not exist",
        "Because the credit side (rate → time structure → malinvestment → liquidation) is the only explanation with a causal mechanism rather than a mere correlation; the halving is a known parameter and narrative an amplifier",
        "Because Austrians oppose Bitcoin",
        "Because narratives do not matter",
      ],
      answer: 1,
      explain: "All three peaks matched fiat easing plus internal crypto credit expansion, and the 2022 crash matched hikes and the Celsius/FTX contraction; the halving is anticipated and should be priced in; reflexive narrative (Stage 16.5) gives direction, credit gives fuel.",
    },
  ],

  further: [
    { label: "Mises, The Theory of Money and Credit — the original statement of “fiduciary media” and the cycle theory", url: "https://mises.org/library/book/theory-money-and-credit" },
    { label: "Rothbard, What Has Government Done to Our Money? (1963) — the gold standard, war finance and suspension", url: "https://mises.org/library/book/what-has-government-done-our-money" },
    { label: "Selgin, The Theory of Free Banking (1988) — the clearing constraint and banking without a lender of last resort", url: "https://www.cato.org/books/theory-free-banking" },
    { label: "Huerta de Soto, Money, Bank Credit, and Economic Cycles (1998) — the 100%-reserve camp's full argument on cycles", url: "https://mises.org/library/book/money-bank-credit-and-economic-cycles" },
    { label: "Poon & Dryja, “The Bitcoin Lightning Network: Scalable Off-Chain Instant Payments” (2016) — the Lightning white paper", url: "https://lightning.network/lightning-network-paper.pdf" },
  ],
};
