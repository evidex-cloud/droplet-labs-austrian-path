...
# vs Keynes: Aggregate Demand, Multipliers & 'Animal Spirits'
...
What about money? Here Keynes had a genuine point: in a monetary economy one can “sell without buying” — hold the cash. Austrians grant this entirely ([[money-demand|Stage 4.2]] on money demand is about exactly that). But watch where the reasoning forks:
...
The question then becomes “why don't prices adjust?” — and for the United States of 1930–33 the answer is concrete: the Hoover administration lobbied firms to hold wages up, the tariff and later the National Industrial Recovery Act pinned prices in place ([[abct-history|Stages 5.4]] and 13.2). **Stickiness is not a natural property of markets; much of it is manufactured by policy.** Austrians of course concede that contracts, habit and information make wages move slowly — but “slowly” and “stuck forever” are different claims.
...
That thread runs to the present. [[vs-mmt|Stage 11.4]]'s MMT is Keynesian logic with the last rail removed; [[case-great-depression|Stage 13.2]] sets the two explanations of 1929–33 side by side against the data; and in [[ai-bubble-abct|Stage 18.5]] you will apply the same “is the interest rate lying?” test to the AI capital-spending frenzy.
...
## @misconceptions
- **“Austrians deny that a shortfall in demand can cause a recession.”** — No. Austrians accept that a sudden rise in money demand (people hoarding cash) can cause a real fall in output; [[money-demand|Stage 4.2]] says so plainly. The disagreement is over mechanism and remedy: Austrians hold that falling prices and interest rates can absorb the shock, that “getting stuck” usually means prices were pinned by policy — and that the original cause is typically prior credit expansion, not thrift.
...
- **“Keynes won because the Depression proved him right.”** — The Depression can be explained in Keynesian terms and in Austrian terms (credit expansion plus obstructed liquidation); [[case-great-depression|Stage 13.2]] compares them side by side. Buchanan and Wagner's point is that Keynes's victory was largely political: his theory gave politicians a reason to spend and removed the balanced-budget constraint. Whether a theory suits politicians and whether it is true are separate questions.

## @quiz
1. In Keynes's theory of liquidity preference, what is the interest rate?
   - [ ] The exchange ratio between present and future goods
   - [x] The reward demanded for parting with liquidity (holding cash)
   - [ ] The physical productivity of capital
   - [ ] The profit rate of banks
   > Keynes defined interest as the reward for parting with liquidity, set by money supply against liquidity preference. Austrians hold that interest is **the price of time**, rooted in time preference, and that money can only disturb it temporarily.

2. Town income is 1,000, MPC is 0.8, and the townspeople decide to save 50 more. On the Austrian analysis, what is most likely to happen?
   - [ ] Income falls by 250 and investment is unchanged
   - [x] The interest rate falls, investment rises by about 50, total spending is unchanged but shifts from consumption toward early stages
   - [ ] Income rises by 250 because saving is investment
   - [ ] Nothing changes because saving is only a bookkeeping entry
   > Saving is demand for future goods: the extra 50 enters the loan market and lowers the rate, making long projects that did not pay before profitable — **output moves along the time axis** rather than vanishing. Option A is Keynes's ledger.

3. Why did Hayek never review the General Theory?
   - [ ] He agreed with it entirely
   - [ ] He was forbidden to publish
   - [x] Keynes had told him he no longer believed the Treatise on Money; Hayek assumed the General Theory was another passing position and was busy writing The Pure Theory of Capital
   - [ ] He never read it
   > Hayek later called it a major mistake: he misjudged the book's staying power and poured his effort into The Pure Theory of Capital (1941), which nobody read, leaving Keynesianism to become orthodoxy unopposed.

4. Properly stated, what does Say's law rule out?
   - [ ] A glut in any particular good
   - [ ] A rise in the demand for money
   - [x] A simultaneous glut in all markets (a general glut)
   - [ ] Any form of unemployment
   > Say argued that production is the source of demand; the law allows structural mismatch (too much A, too little B) and rules out the self-contradictory notion that everything is unsaleable at once. “Supply creates its own demand” is Keynes's oversimplified paraphrase.

5. What do Keynes's 1937 QJE article and the Austrians have in common?
   - [ ] Both hold that the government spending multiplier exceeds 1
   - [x] Both hold that the future is fundamentally incalculable (radical uncertainty)
   - [ ] Both hold that interest is a monetary phenomenon
   - [ ] Both advocate the gold standard
   > “We simply do not know” — Keynes's 1937 position is nearly identical to Mises's case probability and to Lachmann and Shackle. The split is over whether uncertainty implies stabilization by the state or the impossibility of stabilization from above.

## @further
- [Keynes, The General Theory of Employment, Interest and Money (1936) — full text](https://www.marxists.org/reference/subject/economics/keynes/general-theory/)
- [Hayek, Contra Keynes and Cambridge — the 1931–32 Economica reviews and Keynes's reply (Mises Institute)](https://mises.org/library/book/contra-keynes-and-cambridge)
- [Hazlitt, The Failure of the “New Economics” (1959) — a chapter-by-chapter dissection of the General Theory](https://mises.org/library/book/failure-new-economics)
- [Garrison, Time and Money (2001), Chs. 3–4 — Keynes and the Austrians compared in three diagrams](https://mises.org/library/book/time-and-money-macroeconomics-capital-structure)
- [Buchanan & Wagner, Democracy in Deficit (1977) — why Keynes won politically (Econlib full text)](https://www.econlib.org/library/Buchanan/buchCv8.html)
