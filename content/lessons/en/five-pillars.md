...
# The Map: Five Pillars of Austrian Economics
...
**① Value lives in minds, not in things (subjectivism).** A glass of water in a desert and a glass by a river are two entirely different things; the same phone is a tool to one person and a toy to another. Nothing is worth some amount “in itself” — what it is worth is always **a particular person's judgment in a particular situation**. All of [[diamonds-water|Stage 1]] builds this pillar ([[subjective-value|Stage 1.2]] is its direct statement).

**② People choose at the margin (marginalism).** You never choose between “water” and “diamonds,” only between “one more bucket” and “one more diamond”; a shop never chooses between “selling” and “not selling,” only between “one more unit at this price, or cut the price?” Value, price and cost all happen at **the unit on the boundary**. [[diamonds-water|Stage 1.1]] builds it with diamonds and water; [[price-formation|Stage 1.3]] uses it to explain how prices form.

**③ Only individuals act, and action is purposeful (methodological individualism and praxeology).** “The market panicked,” “the state decided,” “society needs” — none of those subjects can actually act. Only particular people act, and their action is purposeful: means pursuing ends. The laws of economics are deduced from that one fact ([[action-axiom|Stage 2]]).

**④ Time is real, capital is heterogeneous, the future is uncertain (real time, capital and uncertainty).** Production takes time, and waiting must be paid for (interest); capital goods are not putty — a printing press cannot be reshaped into a tractor; and every action points at a future nobody knows, so every entrepreneur is **placing a bet**. [[time-preference|Stage 3]] covers time and capital, [[abct-one-picture|Stage 5]] what happens when a distorted interest rate makes a whole society bet wrong together, [[entrepreneur-alertness|Stage 6]] how entrepreneurs find their way through uncertainty.

**⑤ Prices carry knowledge, and order can grow rather than be designed (the price system and spontaneous order).** Nobody knows the full state of the world's copper mines, demand, substitutes and shipping, but the price of copper compresses all of it into one number that tells everyone “economize now” or “use freely.” Without prices there is no economic calculation — Mises's 1920 argument ([[mises-1920|Stage 7.1]]); prices transmit dispersed knowledge — Hayek's 1945 argument ([[hayek-knowledge|Stage 7.2]]). And money, law, language and the market itself are orders nobody designed that work very well ([[spontaneous-order|Stage 7.4]], [[why-property|Stage 9]]).
...
A map is most useful when you are lost. Ninety-odd lessons lie ahead, and somewhere in the middle you will forget why you are learning a given thing. Come back here and ask: **which pillar is this?** The Cantillon effect of [[cantillon-inflation|Stage 4.3]] — pillar ③ (new money is always spent first by some particular person) plus pillar ⑤ (the price signal is falsified). Network effects in [[network-effects|Stage 15.1]] — pillars ① and ② (my valuation of a platform depends on whether others use it too, and that valuation happens at the margin of “one more user”). “Can AI replace entrepreneurial judgment?” in [[ai-judgment|Stage 18.3]] — pillar ④ (judgment is betting under uncertainty, and uncertainty is not a shortage of data but a future that has not happened yet).

**In this lesson we break it into six pieces:**

- **① Pillar one · Subjectivism: value lives in minds (→ [[diamonds-water|Stage 1]])**
- **② Pillar two · Marginalism: everything happens at the boundary (→ [[diamonds-water|Stage 1.1]], [[price-formation|Stage 1.3]])**
- **③ Pillar three · Methodological individualism and praxeology: only people act (→ [[action-axiom|Stage 2]])**
- **④ Pillar four · Real time, capital and uncertainty: why things go wrong (→ [[time-preference|Stages 3]], 5, 6)**
- **⑤ Pillar five · Prices as knowledge and spontaneous order: coordination without a coordinator (→ [[mises-1920|Stages 7]], 9)**
...
**What it rules out:** The labor theory of value ([[vs-marx-behavioral|Stage 11.5]]) — spend 1,000 hours carving a wooden figure nobody wants and those hours create no value. Cost-determines-price — cost is itself imputed from consumers' valuations ([[diamonds-water|Stage 1.1]]). “Objective needs” — no central body can judge for you what you “really need.”
...
**Where it lives in the course:** [[subjective-value|Stage 1.2]] states it directly; [[opportunity-cost|Stage 1.4]] (opportunity cost is subjective), [[money-demand|Stage 4.2]] (the value of money is subjective too), [[zero-marginal-cost|Stage 15.3]] (why zero-marginal-cost software sells for money) and [[attention-economy|Stage 16.1]] (why attention is valuable) apply it.
...
**What it solves:** The diamond–water paradox ([[diamonds-water|Stage 1.1]]) — water's total usefulness is enormous, but the marginal use of the bucket in your hand is tiny. Price formation ([[price-formation|Stage 1.3]]) — Böhm-Bawerk's marginal pairs: the price sits between the last pair that trades and the first pair that does not.
...
**Where it lives in the course:** Built in [[diamonds-water|Stage 1.1]] and [[price-formation|Stage 1.3]]; [[time-preference|Stage 3.1]] (marginal time preference sets the interest rate), [[profit-loss|Stage 6.3]] (profit and loss are signals at the margin) and [[network-effects|Stage 15.1]] (a network effect is the rising marginal value of “one more user”) all rest on it.

### ③ Pillar three · Methodological individualism and praxeology: only people act (→ [[action-axiom|Stage 2]])

**What it says:** Two sentences. **Methodological individualism:** any social phenomenon must ultimately be explained through the actions of particular people — “the class,” “the state,” “the market,” “AI” do not act. **Praxeology:** human action is purposeful (means pursuing ends), and the laws of economics are deduced logically from that, not induced from statistics ([[action-axiom|Stage 2.1]], [[apriori-empirical|Stage 2.2]]).

**What it rules out:** Treating aggregates as actors (“aggregate demand wants…”); treating people as measurable physical variables (the “economy as machine” of [[what-economics-studies|Stage 0.1]]); substituting correlation for causation (“the data show X moves with Y, so X causes Y” — [[empirical-method|Stage 13.1]] shows how Austrians do empirical work instead).

**A numerical example:** “The central bank injects $100 billion of liquidity and the economy gets a boost.” Pillar three makes you ask: **who** got the $100 billion first? Banks. Whom did they lend it to? Large firms and property developers. What did those buy? Land, machines, shares. Those prices rise first; wage earners see higher prices at the supermarket months later — the Cantillon effect of [[cantillon-inflation|Stage 4.3]]. “The economy gets a boost” has no subject; put the subject back and the conclusion changes.

**Where it lives in the course:** All of [[action-axiom|Stage 2]]; [[economics-of-state|Stage 8.4]] (“the state” is also a group of purposeful people: public choice), [[ai-capital-good|Stage 18.2]] (AI is a capital good; the people using it are the actors), [[agent-economies|Stage 18.6]] (behind algorithmic pricing there are still people who set the algorithm).

### ④ Pillar four · Real time, capital and uncertainty: why things go wrong (→ [[time-preference|Stages 3]], 5, 6)

**What it says:** Three things. **Real time:** production is a process — from sowing to harvest, from drawing to mass production — with waiting in between; waiting must be paid for, that payment is interest, and its root is time preference ([[time-preference|Stage 3.1]]). **Heterogeneous capital:** capital goods are specific to uses and arranged in stages from upstream to downstream ([[roundabout-production|Stage 3.2]], [[heterogeneous-capital|Stage 3.4]]); capital invested in the wrong place cannot be moved back without loss. **Uncertainty:** the future is not “risk with known probabilities” but genuine unknown; entrepreneurial judgment is betting inside that unknown ([[entrepreneur-alertness|Stage 6.1]]).

**What it explains:** The business cycle ([[abct-one-picture|Stage 5.1]]) — push the interest rate below the natural rate and the whole society believes saving has risen, so it starts too many long projects at once; there are not enough resources to finish them all, and liquidation follows. Not “market failure,” but “collective misjudgment after the signal was falsified.”

**A numerical example:** Natural rate 5%; the central bank pushes it to 2%. A 10-year project has a net present value of −$8 million at 5% (don't do it) and +$12 million at 2% (do it). A hundred such projects across the city break ground together. But real saving has not changed; two years later steel, workers and finance are all short, and half the projects are abandoned. Unfinished plants cannot become anything else — that is the price of heterogeneous capital. [[boom-malinvestment|Stage 5.2]] walks the process step by step in numbers.

**Where it lives in the course:** All of [[time-preference|Stages 3]], 5 and 6; [[garrison-macro|Stage 10.1]] (Garrison's three diagrams), [[bitcoin-cycles|Stage 17.5]] (would there be cycles under a Bitcoin standard?), [[ai-bubble-abct|Stage 18.5]] (is the AI capex frenzy malinvestment?).

### ⑤ Pillar five · Prices as knowledge and spontaneous order: coordination without a coordinator (→ [[mises-1920|Stages 7]], 9)

**What it says:** One sentence from each master. **Mises 1920:** without private ownership of the means of production there is no market for them, without a market no prices, without prices no economic calculation — you cannot know whether a ton of steel is better used in a bridge or a ship, because “better” can only be compared in prices ([[mises-1920|Stage 7.1]]). **Hayek 1945:** knowledge is dispersed across countless minds, most of it tacit knowledge that cannot be stated (“this machine is running oddly today,” “these customers have grown pickier lately”); prices compress that knowledge into a number, so everyone who knows only their corner can adjust consistently with the whole ([[hayek-knowledge|Stage 7.2]]). Add one more: the market, money, law and language are **spontaneous orders** — nobody designed them and they work ([[spontaneous-order|Stage 7.4]], [[spontaneous-law|Stage 9.3]]).

**What it rules out:** Central planning (why Lange's model failed, [[lange-market-socialism|Stage 7.3]]); “big data or AI can replace prices” ([[bigdata-planning|Stage 7.5]], [[ai-central-planning|Stage 18.1]]) — the problem is not compute, it is that **the data do not exist before prices form**: without prices, nobody has a reason to discover and express that knowledge.
...
**Where it lives in the course:** All of [[mises-1920|Stages 7]] and 9; [[competition-process|Stage 6.2]] (competition as a discovery procedure), [[data-new-oil|Stage 15.4]] (is data the new oil?), [[algorithms-order|Stage 16.2]] (are recommendation algorithms a discovery procedure or a manipulation machine?), [[defi-code-order|Stage 17.4]] (DeFi as spontaneous order in code).
...
The five pillars together conclude (worked out in [[price-controls|Stage 8.2]]): **the people the ordinance meant to protect are, a few years later, the ones who cannot find a place.** That is not ideology; it is five pillars, each deduced in turn.

**Example two: a lab releases a new AI model.** A preview of [[ai-central-planning|Stage 18]].
...
- **Pillar ②:** The marginal cost of serving one more user is near zero, but the price is set by the marginal user's valuation, not by copying cost ([[zero-marginal-cost|Stage 15.3]]); tiered subscriptions are pricing at different margins.
- **Pillar ③:** Sentences of the form “AI will…” have no subject. AI is a **capital good** ([[ai-capital-good|Stage 18.2]]) — an unusually powerful machine. The actors are the firm that built it, the developers who use it, the businesses that buy it; the analysis has to land on their ends and means.
- **Pillar ④:** Training a model takes years and billions of dollars of GPUs and data centers — highly specific **heterogeneous capital** that is hard to repurpose if demand disappoints. The financing cost of those projects depends on the interest rate; if the rate is held too low, will some of them turn out to be projects that cannot be completed? [[ai-bubble-abct|Stage 18.5]] asks that question with ABCT (and is not investment advice). And which use cases will actually pay is something nobody knows — the territory of entrepreneurial judgment, and the starting point for [[ai-judgment|Stage 18.3]]'s question “can judgment be automated?”
- **Pillar ⑤:** The prices of compute and tokens are telling the whole industry “economize” or “use freely”; and whether AI can replace prices to run central planning ([[ai-central-planning|Stage 18.1]]) — the five pillars answer no, because the data it would need are only produced in the process of prices forming.

Compress the lesson into one sentence: **subjectivism and marginalism tell you where value comes from; methodological individualism and praxeology tell you how economics is studied; real time and uncertainty tell you why things go wrong; prices and spontaneous order tell you why coordination happens without a coordinator.** With the five pillars standing, the next step is [[diamonds-water|Stage 1.1]] — building the first one yourself, starting from a bucket of water.
...
- **“Uncertainty is just missing data; once AI gathers enough, judgment can be automated.”** — The uncertainty Austrians mean is not “risk with unknown probabilities” but a future that has not happened and depends on choices not yet made. Which use case will pay, what consumers will like next year — these are not data hidden somewhere awaiting collection; they come into existence only after people act. That is the heart of [[ai-judgment|Stage 18.3]].
- **“The price system = markets are perfect; Austrians deny all failure.”** — Pillar ⑤ says prices carry knowledge and that without prices there is no economic calculation; it does not say markets always reach the best result. Austrians hold that error is everywhere — entrepreneurs err daily, which is exactly why profit and loss exist ([[profit-loss|Stage 6.3]]). What they deny is that an institution without prices could err less than a market with them.

## @quiz
1. “Same concert ticket: A would pay $300, B at most $20, C wouldn't go if paid.” Which pillar does this most directly illustrate?
   - [ ] Pillar ④ real time and uncertainty
   - [x] Pillar ① subjectivism: value is an acting person's judgment in a specific situation, not a property of the ticket
   - [ ] Pillar ⑤ spontaneous order
   - [ ] Pillar ③ methodological individualism
   > The ticket is worth nothing “in itself”; it is worth a different number to each person, and those numbers can only be ranked, not measured. A market price of $50 says only that at the margin someone will buy and someone will sell — where pillar ② takes over.

2. An airline cuts its last 12 seats from $800 to $300 the day before departure. Which pillar explains it best?
   - [x] Pillar ② marginalism: the marginal cost of those 12 seats is near zero, marginal revenue of $300 exceeds it, and pricing looks at the margin rather than average cost
   ...
   > The plane flies regardless; carrying one more passenger costs almost nothing. As long as marginal revenue exceeds marginal cost, sell. Pricing never looks at “average cost” — that is pillar ②.

3. “The central bank injects $100 billion of liquidity and the economy gets a boost.” What does pillar ③ make you ask?
   ...
   - [x] Who received the $100 billion first, what they bought, and who saw higher prices last — putting the subject back into a subjectless sentence
   > “The economy” cannot be boosted; particular people are affected: banks and large firms who get the money first buy assets at old prices, and wage earners face higher prices months later (the Cantillon effect, [[cantillon-inflation|Stage 4.3]]). Put the subject back and the conclusion changes.

4. In the rent-control example, why is the shortage small in year one and severe after three to five years?
   - [ ] Because landlords need time to read the ordinance
   - [x] Because of pillar ④: the existing stock is still there, but new buildings (4-year projects) have negative NPV at the capped rent and old ones go unmaintained — capital consumption takes time to show
   - [ ] Because of pillar ①: tenants' valuations slowly change
   - [ ] Because the government relaxes the cap year by year
   > Real time and heterogeneous capital: housing is a stock that does not vanish overnight; but construction and maintenance stop, and supply shrinks over time. That is also why controls look “effective in the short run” — [[price-controls|Stage 8.2]] works it through.

5. “Once AI has gathered all the data, it can replace prices and run central planning.” What do the five pillars answer?
   - [ ] Yes, given enough compute
   - [ ] Yes, because prices are just a function of historical data
   - [x] No, because the data that price formation requires (people's subjective valuations, tacit knowledge, choices not yet made) are produced only in the process of prices forming and people acting — they are not sitting somewhere waiting to be collected
   - [ ] No, because AI is biased
   > Pillar ① (valuations live in minds) + pillar ⑤ (prices compress valuations) + pillar ④ (the future has not happened): the difficulty of central planning is not compute but “the data do not exist before prices.” [[bigdata-planning|Stage 7.5]] and [[ai-central-planning|Stage 18.1]] develop this.

## @further
- [Econlib Encyclopedia: Austrian School of Economics (Peter Boettke) — the “pillar map” in ten-proposition form](https://www.econlib.org/library/Enc/AustrianSchoolofEconomics.html)
- [Mises Institute: What Is Austrian Economics? — the school's own summary of its core propositions](https://mises.org/what-austrian-economics)
- [Hayek, “The Use of Knowledge in Society” (1945) — the source text for pillar ⑤ (full text, Econlib)](https://www.econlib.org/library/Essays/hykKnw1.html)
- [Mises, “Economic Calculation in the Socialist Commonwealth” (1920) — the other half of pillar ⑤ (full text, Mises Institute)](https://mises.org/library/book/economic-calculation-socialist-commonwealth)
- [Rothbard, Man, Economy, and State, Ch. 1 “Fundamentals of Human Action” — a systematic statement of pillars ①, ② and ③](https://mises.org/library/book/man-economy-and-state-power-and-market)
