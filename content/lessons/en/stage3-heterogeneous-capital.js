...
Lachmann's capital theory is the hidden thread of the whole Austrian business-cycle story. If capital were putty, the “malinvestment” caused by an artificially low rate (Stage 5.2) would be a minor misallocation, quickly corrected; precisely because capital is a jigsaw, what was built wrong in the boom becomes a real, painful loss in the bust. It is also the root of Stage 10.2's question — can a “capital stock” be measured at all? — and the core tool for Stages 15.4 and 18.2 on data and AI: a trained model, a GPU data center, a proprietary dataset are all **highly specific, highly complementary** capital goods.
...
**To Clark/Knight**: the river metaphor holds in an **evenly rotating economy** (the ERE of Stage 2.4) — everything replaced on schedule, no surprises. But the crux of the real world is precisely that **plans go wrong.** When they do, the “fund” does not maintain itself: the bakery's $120k of “capital” does not flow like river water into the next firm; $39.5k of it is gone for good. Hayek's 1936 reply to Knight, “The Mythology of Capital,” says exactly this: only on the assumption that nothing ever goes wrong is capital a permanent fund.

**To Solow**: Austrians do not deny that aggregation is useful for some questions — Garrison himself uses aggregate diagrams. The dispute is over **which questions aggregation erases.** If the question is “what are the consequences of a false interest-rate signal,” the putty assumption defines the answer away: with putty capital, malinvestment costs nothing and a business cycle is logically impossible. **Using a model that assumes no cycle to study cycles, and concluding there is none, is not surprising.** Stage 10.2 examines in more detail when GDP and “capital stock” are good approximations and when they mislead.

And an honest admission: the Austrian triangle of Stage 3.2 is itself a simplification that lines capital goods up by “stage” and erases some heterogeneity too. Lachmann's theory also stirred debate inside the school — his emphasis on “kaleidic” (borrowed from Shackle), ever-shifting expectations struck some as going so far that any theory of market coordination becomes hard to sustain (the internal debates of Stage 14.3).
...
So Lachmann is the foundation of the whole Austrian cycle theory: **without heterogeneous capital there is no concept of malinvestment, and hence no genuine theory of the cycle.** Stages 5.2 and 5.3 unfold that logic.

Finally, two contemporary applications, developed in Stages 15.4 and 18.2, planted here as seeds:

**Data is a capital good, and a highly specific one.** An e-commerce firm's user-behavior data is enormously valuable to its own recommendation plan and worth almost nothing to a steel mill. Data's value comes from the plan it is embedded in — which is why the analogy “data is the new oil” fails: oil is fairly general-purpose, data extremely specific (Stage 15.4).

**AI is a capital good with extreme complementarity.** A GPU data center has value only **fitted together with** electricity, cooling, training data, algorithmic talent and some concrete business plan. Once a class of models' commercial plan is shown not to hold, the hardware customized for it strands like the bakery's molds — the central question when Stage 18.5 reads the AI capex frenzy through ABCT: **how specific are these pieces, and whose plan is holding them up?** The demo lets you assemble a production plan by hand, take a demand shock, count how many pieces can be re-used — then flip the “putty” switch to see how the mainstream model defines those losses away.
`,
...
Lachmann's whole insight in a sentence: **the economy is not shoveling sand; it is assembling a jigsaw, and every piece is an entrepreneur's guess about the future.** Guess right and the pieces lock together and value appears; guess wrong and the pieces strand and value disappears. Stage 5.2 is about the case where many people guess wrong at once — because the rate they were looking at was lying.
`,
  ...
  quiz: [
    {
      q: "After the bakery's plan fails, the van sells at a 15% discount while the custom molds go for scrap. In Lachmann's framework, what explains the difference?",
      options: [
        "The van is of better physical quality",
        "The molds depreciate faster",
        "The van's set of uses is large (general); the molds' set has essentially one member (highly specific), so once the original plan is gone the molds find no new plan",
        "There is a used-van market but no used-mold market — a market failure",
      ],
      answer: 2,
      explain: "**Multiple specificity**: every capital good has a limited set of uses. The larger the set, the more value survives regrouping; the smaller, the likelier it strands. The molds' value came from a plan that no longer exists.",
    },
    {
      q: "Lachmann says complementarity is the relation that holds while a plan runs, and substitutability surfaces when plans change. What does that mean?",
      options: [
        "Capital goods are either complements or substitutes, never both",
        "Inside a running plan, capital goods make each other valuable; only when the plan fails and regrouping is needed does the question “what can this replace in some other plan?” arise",
      ...
      answer: 1,
      explain: "The oven, storefront and chefs are complements inside the bakery plan; only after the bakery closes does the question “which other plan can the oven enter?” arise — and substitutability enters the stage. They are two relations of the same good at different moments.",
    },
    {
      q: "Clark and Knight likened capital to a river: droplets change, the river persists. What is the core Austrian reply?",
      options: [
        ...
        "The metaphor holds only in an evenly rotating economy where everything goes to plan; once plans fail, the “fund” does not maintain itself and part of the value is gone for good",
      ],
      answer: 3,
      explain: "Hayek's argument in “The Mythology of Capital” (1936): **only on the assumption that nothing ever goes wrong is capital a permanent fund.** The crux of the real world is that plans go wrong, and regrouping afterwards carries real losses.",
    },
    {
      q: "Why does “putty or jigsaw” decide whether a theory of the business cycle can exist at all?",
      options: [
        "With putty, malinvestment can be reshaped costlessly and a cycle is logically impossible; with a jigsaw, malinvested goods are discounted or stranded, the loss is real, and the bust has substance",
      ...
      answer: 0,
      explain: "**Without heterogeneous capital there is no concept of malinvestment.** A model that assumes costless reallocation and concludes that cycles are mere demand wobbles has defined the answer away.",
    },
    {
      q: "What did Samuelson concede in 1966 in the Cambridge capital controversy?",
      options: [
        "That the Austrian business-cycle theory is correct",
        "That the rate is set by the central bank",
        "That reswitching is real and the aggregate production function has no general foundation — K cannot be measured independently of the rate",
        "That capital is perfectly homogeneous",
      ],
      answer: 2,
      explain: "“A Summing Up” conceded reswitching. Austrians partly agree with the conclusion (capital is not a quantity) but for different reasons: capital goods draw value from subjective, heterogeneous entrepreneurial plans, and the rate comes from time preference.",
    },
  ],

  further: [
    { label: "Lachmann, Capital and Its Structure (1956) — full text (Mises Institute)", url: "https://mises.org/library/book/capital-and-its-structure" },
    { label: "Hayek, “The Mythology of Capital” (1936) — the reply to Knight's “permanent fund”", url: "https://mises.org/library/book/mythology-capital" },
    { label: "Kirzner, An Essay on Capital (1966) — Austrian capital theory restated in terms of plans and purposes", url: "https://mises.org/library/book/essay-capital" },
    { label: "Peter Lewin, Capital in Disequilibrium (1999) — the contemporary systematic restatement of Lachmann's theory", url: "https://mises.org/library/book/capital-disequilibrium-role-capital-changing-world" },
    { label: "Samuelson, “A Summing Up,” Quarterly Journal of Economics (1966) — the concession in the Cambridge controversy (JSTOR)", url: "https://www.jstor.org/stable/1882916" },
  ],
};
