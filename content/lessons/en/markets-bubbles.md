...
# Financial Markets through Austrian Eyes: Stocks, Bonds & Bubbles
...
The basic formula of finance is one Austrians accept whole, because it is simply the time preference of [[time-preference|Stage 3.1]] applied:

$$
\begin{aligned}
&\text{Asset price } P = \sum_{t} \dfrac{\mathit{CF}_{t}}{(1+r)^{t}} \\[6pt]
&\mathit{CF}_{t}\text{: the cash you expect in year }t\text{;} \\
&r\text{: the discount rate (required return)}
\end{aligned}
$$
...
$$
\begin{aligned}
r = 5\%\text{:} &\quad \text{cash cow} \approx 154,\quad \text{growth story} \approx 100 \\
r = 1\%\text{:} &\quad \text{cash cow} \approx 258,\quad \text{growth story} \approx 241 \\[4pt]
\text{from }5\%\text{ to }1\%\text{:} &\quad \text{cash cow} \times 1.7,\quad \text{growth story} \times 2.4
\end{aligned}
$$
...
The three diagrams of [[garrison-macro|Stage 10.1]] say credit expansion pushes the rate down, stretches the triangle's upstream end, lifts its downstream end and hollows out the middle. Mapped onto the stock market, that is **a predictable sector rotation**:
...
**To Minsky**: the slide from hedge to Ponzi finance is an accurate description of a boom — the malinvestment piling up in [[boom-malinvestment|Stage 5.2]] is, in Minsky's language, ever more projects turning into speculative finance. But Minsky never asked the next question: **why can credit expand round after round without being constrained by real saving?** In a world of 100% reserves or hard money, a bank can only lend what someone has first deposited, and Ponzi finance quickly hits a funding ceiling. Minsky treats elastic credit as a natural tendency of the financial system; Austrians point to its institutional preconditions — the fractional reserves of [[fractional-reserve|Stage 4.4]] and the central bank as lender of last resort in [[central-banks-fiat|Stage 4.5]]. Minsky's prescription is more regulation; the Austrian prescription is to remove the institutions that manufacture elastic credit.
...
- A textbook Cantillon effect ([[cantillon-inflation|Stage 4.3]]): the new money reached financial assets first, and CPI caught up a year later.
...
The Austrian reading of this episode: **the denominator was pushed down and everything was lifted; the denominator normalized and everything was set back down.** Most of the magnitude can be explained without assuming “crowd madness” — though madness was present too. [[abct-history|Stage 5.4]] and [[case-2008-qe|Stage 13.4]] cover this history from the cycle and policy sides; [[memes-reflexivity|Stage 16.5]] takes up GameStop as an extreme case of narrative and reflexivity; [[ai-bubble-abct|Stage 18.5]] asks whether today's AI capital spending is the next instance.
...
- **“This lesson is telling me what to buy.”** — It is not. It explains how rates lever valuations, how sectors rotate as the triangle stretches, and what inflates bubbles — frameworks and history throughout. It recommends no asset; [[austrian-investing|Stage 10.5]] explains why Austrian theory itself forbids treating it as an investment instruction.

## @quiz
1. A company pays you a steady 10 a year forever. The discount rate falls from 5% to 1%. Its value goes from what to what?
   - [ ] 200 → 250
   - [x] 200 → 1,000
   - [ ] 100 → 500
   - [ ] Unchanged, since the cash flow did not change
   > A perpetuity is worth CF ÷ r: 10 ÷ 0.05 = 200, 10 ÷ 0.01 = 1,000. Not a cent of cash flow changed and the price rose fivefold — the rate flowing straight into the valuation.

2. Why did unprofitable tech companies fall far more than utilities when rates rose in 2022?
   - [ ] Because their products were bad
   - [ ] Because utilities are protected by government
   - [ ] Because investors irrationally dumped tech
   - [x] Because their cash flows lie in the distant future — long duration — so their valuations are the most sensitive to the discount rate
   > The further out the cash flows, the longer the lever. From 1% back to 5% the growth story falls about 58% and the cash cow about 40%. The 2022 declines ranked almost perfectly by duration.

3. What is the Austrian reply to Shiller's “irrational exuberance”?
   - [ ] Psychology is not economics; Shiller is simply wrong
   - [x] Narrative contagion is real, but pushing assets up takes real money, and without credit expansion that money does not exist — psychology is the amplifier, credit the power supply
   - [ ] Shiller is an Austrian
   - [ ] Bubbles do not exist; markets are always efficient
   > Austrians do not deny the psychological mechanism; they add an accounting constraint — every great bubble coincided with rapid credit or money-supply expansion. Shiller explains why an asset class was chosen; Austrians explain why the money was there.

4. On Skousen's view of the stock market as a capital-structure map, which sectors rise first and most in the early boom?
   - [ ] Retail and food (downstream)
   - [ ] Utilities
   - [x] Long-duration upstream sectors: tech, biotech, property development, mining equipment
   - [ ] All sectors rise evenly
   > Credit expansion stretches the triangle's upstream end; in the market that shows as the sectors farthest from consumption, with the most distant cash flows, rising first and most — and falling first in the bust. Downstream staples and utilities hold up relatively well.

5. What can Austrian theory say about financial markets, and what can it not?
   - [x] It can speak to direction and fragility; it cannot speak to timing or magnitude
   ...
   > Depressed rate → long-duration assets overvalued → they fall hardest on normalization: that is direction. A structure built on 1% is more fragile than one built on 5%: that is fragility. When it normalizes and how far things fall depend on politics and accidents — history, not theory.

## @further
- [Mark Skousen, The Structure of Production (1990) — the source of the stock market as a cross-section of the capital structure](https://mises.org/library/book/structure-production)
- [Robert Shiller, Irrational Exuberance — the book's official page, with CAPE data](http://www.irrationalexuberance.com/)
- [Hyman Minsky, “The Financial Instability Hypothesis” (1992, Levy Institute working paper)](https://www.levyinstitute.org/pubs/wp74.pdf)
- [Mises Institute: Business Cycles topic page (Austrian cycle theory applied to markets)](https://mises.org/topics/business-cycles)
- [Econlib encyclopedia: Present Value (the foundation of discounting and valuation)](https://www.econlib.org/library/Enc/PresentValue.html)
