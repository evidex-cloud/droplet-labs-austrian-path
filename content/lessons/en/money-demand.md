...
# Money Demand & Purchasing Power: Why Money Is Never Neutral
...
Mises, in *The Theory of Money and Credit* (1912), called this the **demand for cash balances**. Everyone carries a number in their head: “I want to hold roughly X in money.” X depends on the rhythm of your income, how uncertain the future feels, the opportunity cost of holding cash ([[opportunity-cost|Stage 1.4]]: money in an account earns no return and does not appreciate), and what you expect prices to do. Add up everyone's X and you have society's demand for money.

Now apply the supply-and-demand logic of [[price-formation|Stage 1.3]]. The supply of money is the quantity of money in the economy; the demand for money is the sum of the cash balances people want to hold; where they meet, a “price” is set — **how much a unit of money buys**, its purchasing power. Purchasing power is not one number but a whole list: how many eggs a dollar buys, how many minutes of a haircut, how many square inches of a house.
...
Why does the distinction matter? Because it puts monetary theory back on the feet of the **acting person** ([[action-axiom|Stage 2.1]]). What changes purchasing power is not an abstract “velocity” but millions of concrete decisions about “how much cash do I want to hold.” When people feel more uncertain about the future, they hold more; when they expect prices to rise, they hold less. Summed, those decisions are shifts in the demand for money. The regression theorem of [[origin-of-money|Stage 4.1]] guarantees that the decisions have a reference point: yesterday's purchasing power.
...
Draw the logic above as the supply-and-demand diagram of [[price-formation|Stage 1.3]]. The horizontal axis is the quantity of money; the vertical axis is **the purchasing power of money** (PPM) — note, not the “price level” but its inverse: how much a dollar buys.

- **The supply curve.** At any moment the stock of money is given, so it is a vertical line. Under gold money the supply is set by mining costs and grows about 1–2% a year; under fiat money it is set by the central bank and the banking system ([[fractional-reserve|Stages 4.4]] and 4.5).
...
**Second, P and T are aggregates, and aggregates hide relative prices.** The “price level” is a weighted average of thousands of prices. An unchanged average can conceal house prices up 30%, food up 5%, and electronics down 15%. But economic calculation ([[mises-1920|Stage 7.1]]) and entrepreneurial judgment ([[entrepreneur-alertness|Stage 6.1]]) run on **relative** prices, not averages. MV=PT is structurally blind to money's effect on relative prices — it defines non-neutrality away. [[aggregates-limits|Stage 10.2]] examines the limits of GDP, CPI and other aggregates in detail.
...
That 7.5% is not harmless. Entrepreneurs who see capital-goods prices rising fastest read it as “the market wants more capital goods” and expand capacity — build plants, buy machinery. This is exactly where the malinvestment of [[boom-malinvestment|Stage 5.2]] begins. And the signal is an artifact of the new money, not a change in consumers' time preference ([[time-preference|Stages 3.1]] and 3.5).
...
There is one further layer of non-neutrality: **creditors versus debtors.** When prices rise 10%, the real burden on a debtor paying a fixed interest rate falls, and the real income of a retiree on a fixed pension falls with it; when prices fall, debtors suffer and savers gain. Every change in the quantity of money **redistributes** wealth between people — [[cantillon-inflation|Stage 4.3]] follows that all the way down.

### ⑤ Two myths: “hoarding is a leakage” and the “deflationary spiral” (Salerno's three deflations)

**Myth one: “hoarding is a leakage.”** In the Keynesian framework ([[vs-keynes|Stage 11.1]]) income is either consumed or saved; saving that is not turned into investment “leaks” out of the circular flow and leaves aggregate demand short. Holding cash is treated as the worst kind of leakage.
...
## @quiz
1. An economy of 100 people holds $10,000 of money. An epidemic makes everyone want to raise their cash balance from $100 to $120; the money supply is unchanged. What happens in the end?
   - [ ] Everyone succeeds in holding $120 and the money stock becomes $12,000
   - [x] Prices fall until $10,000 has the purchasing power $12,000 used to have; each person still holds $100 nominally but a real balance 20% larger
   - [ ] Prices rise, because people's demand has increased
   - [ ] The economy stagnates permanently because all the money is hoarded
   > The total cannot change; everyone buying less and selling more only pushes prices down, and **real balances** are satisfied through higher purchasing power. This is the heart of Mises's cash-balance approach: the demand for money is met by changes in purchasing power, not by printing.

2. What is the core Austrian criticism of V (velocity) in MV=PT?
   ...
   - [x] V is the residual PT ÷ M, not a cause; it is just another way of saying “how large a balance people want to hold”
   > Saying “V is stable” assumes P moves in proportion to M — the conclusion smuggled into the premise. The real causal starting point is each person's decision about cash balances.

3. The money stock rises 10% and the new money enters as bank loans to firms. According to the lesson's example, the most likely final price structure is:
   - [x] Capital goods rise most (about 14%), services least (about 6%), the average about 10%
   ...
   > The new money reaches firms first, who buy capital goods — those rise first and most; it then diffuses to consumer goods and services. The average is near 10%, but **relative prices** have shifted, sending entrepreneurs a false “build more capital goods” signal.

4. From 1873 to 1896 U.S. prices fell about 1–2% a year while real output grew strongly. In Salerno's taxonomy this is:
   - [ ] Bank-credit deflation
   - [ ] Cash-building deflation
   - [x] Growth deflation
   - [ ] Confiscatory deflation
   > Productivity rose and the same money chased more goods — growth deflation, the normal condition of prosperity rather than a catastrophe. Electronics getting cheaper every year while sales grow is the same phenomenon.

5. “When people hold cash, money leaks out of the circular flow.” Why do Austrians disagree?
   ...
   - [x] Because holding cash is itself the demand for cash balances; the money remains with its holder and the market responds through price adjustment
   > Holding an extra $100 = buying $100 less, but the $100 has not vanished; it lowers prices slightly and raises the purchasing power of others' balances. “Hoarding” is merely a pejorative for a higher demand for cash balances.

## @further
- [Mises, The Theory of Money and Credit (1912), Part Two — the cash-balance approach and the determination of purchasing power](https://mises.org/library/book/theory-money-and-credit)
- [Mises, Human Action, Chapter XVII “Indirect Exchange” — money demand, non-neutrality, and the critique of the quantity theory](https://mises.org/library/book/human-action)
- [Joseph T. Salerno, “An Austrian Taxonomy of Deflation”, QJAE (2003) — the classification of deflations](https://mises.org/library/austrian-taxonomy-deflation-particular-reference-us)
- [Irving Fisher, The Purchasing Power of Money (1911) — the original statement of MV=PT (full text at Econlib)](https://www.econlib.org/library/YPDBooks/Fisher/fshPPM.html)
- [Rothbard, Man, Economy, and State, Chapter 11 “Money and Its Purchasing Power”](https://mises.org/library/book/man-economy-and-state-power-and-market)
