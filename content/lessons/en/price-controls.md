...
# Price Controls: Minimum Wages, Rent Control & Price Caps
...
## @intuition
Take the milk example from [[intervention-logic|Stage 8.1]] and replace milk with anything you like. The market price is a number that buyers and sellers bump into at the marginal pair ([[price-formation|Stage 1.3]]): at that price, the people who want to buy exactly match the people who want to sell. Nobody “set” it. It was **discovered**.
...
The most important lesson here is not “controls have side effects” — everyone concedes side effects. It is this: **the side effects are not accidents; they are the direct product of the control, and the intervenor's good intentions have nothing to do with it.** This is the “pattern prediction” of [[individualism-history|Stage 2.3]]: Austrians cannot tell you by what percentage rental supply will shrink after a rent freeze, but they can tell you with certainty that it will shrink, decay, and grow a black market.
...
$$
\begin{aligned}
\text{Demand:}\quad & Q_{d} = 100 - 2P \\
\text{Supply:}\quad & Q_{s} = -20 + 2P \\
\text{Equilibrium:}\quad & 100 - 2P = -20 + 2P \;\rightarrow\; P^{*} = 30,\ Q^{*} = 40
\end{aligned}
$$

**Ceiling at 20**: demand \(Q_{d} = 60\), supply \(Q_{s} = 20\), a **shortage of 40**. Only 20 units actually change hands — half the uncontrolled 40.

**Floor at 40**: demand \(Q_{d} = 20\), supply \(Q_{s} = 60\), a **surplus of 40**. Again only 20 units trade — again half. Note the symmetry: **whichever way you push the price, the quantity traded is set by the short side**, and it is always less than the market's.
...
$$
\text{DWL} = \tfrac{1}{2} \times (40 - 20) \times (40 - 20) = 200
$$

Those 200 were not transferred from buyers to sellers or from sellers to buyers — they **vanished from the world**, because mutually beneficial exchanges that could have happened were forbidden. That is the “value destroyed” of [[intervention-logic|Stage 8.1]].
...
Notice the shared structure of these cases: **the control “protects” the people already inside and punishes everyone trying to get in** — the young, immigrants, anyone changing jobs. And the insiders defend the control with votes and lobbying. That is the “concentrated benefits, dispersed costs” of [[economics-of-state|Stage 8.4]].
...
- **The entry margin**: current staff keep their jobs, but the **next** low-skilled applicant never gets one — Bastiat's unseen ([[opportunity-cost|Stage 1.4]]); no telephone survey counts people who were never hired.
- **Capital substitution**: ordering kiosks, self-checkout, kitchen automation — [[ai-jobs|Stage 18.4]] is devoted to how minimum wages accelerate this. When the price of labour is forced up, relatively cheaper capital goods become more attractive; that is not capitalist “greed,” it is the opportunity cost of [[opportunity-cost|Stage 1.4]] speaking.
- **Product prices and exit**: costs are passed to consumers (often the same low-income people), and marginal firms close.

Third layer: **the limits of the monopsony argument.** Even granting employer power in some local markets, a minimum wage “works” only inside a narrow band — above the competitive wage but below the worker's marginal product. Where that band lies varies by region, industry and age, and it moves over time; a single statewide or national number cannot land inside the band in every market at once. **This is the knowledge problem again** ([[hayek-knowledge|Stage 7.2]]): the regulator does not know the number and has no mechanism for discovering it. Moreover, if employers really do hold monopsony power, the more direct remedy is to **lower the cost of switching jobs** — fewer non-compete clauses, less occupational licensing ([[taxes-regulation|Stage 8.3]]), fewer barriers to relocation — rather than fixing a price.
...
The lesson in one line: **a price is a message; a control is a lie; the lie does not change reality, only who pays for it.** [[five-step-analysis|Stage 14.1]]'s five-step method turns “find every margin of adjustment” into a fixed step.
...
And after the reading is rewritten, the parents discover a new problem: the child still feels awful. So someone proposes controlling the “feeling awful” too — forbid the child to complain of the heat. That is [[intervention-logic|Stage 8.1]]'s spiral in its price-control version.
...
## @quiz
1. Demand \(Q_{d} = 100 - 2P\), supply \(Q_{s} = -20 + 2P\), equilibrium \(P^{*} = 30\), \(Q^{*} = 40\). The government sets a price floor at 40. What happens?
   - [ ] A shortage of 40
   - [x] A surplus of 40, with only 20 actually traded
   - [ ] A surplus of 20, with 40 actually traded
   - [ ] Nothing, because the floor is above equilibrium
   > At a floor of 40: demand 20, supply 60, **surplus 40**; actual trade is set by the short side (demand), so only 20 units — half, exactly as under the ceiling at 20.

2. Under the ceiling at 20, what is the deadweight loss? (At the 20th unit a buyer would pay 40 and the seller's cost is 20; equilibrium quantity is 40.)
   - [ ] 100
   - [ ] 400
   - [x] 200
   - [ ] 800
   > Triangle area = ½ × (40 − 20) × (40 − 20) = **200**. This value is transferred to nobody; it disappears because mutually beneficial exchanges were forbidden.

3. What did Diamond, McQuade and Qian (2019) find about San Francisco's rent control?
   - [ ] The control lowered citywide rents and increased housing supply
   - [x] Affected landlords cut rental supply by about 15%, citywide rents rose, and the control worsened the shortage it aimed to relieve
   - [ ] The control had no measurable effect
   - [ ] The control made it easier for newcomers to find housing
   > A mainstream econometric result: sitting tenants gained, but landlords exited the rental market through sales and conversions, supply shrank about 15%, and the cost fell on all newcomers — matching the Austrian pattern prediction.

4. What is the core Austrian reply to the Card–Krueger study?
   - [ ] Their data were fabricated
   - [ ] A minimum wage always causes immediate mass unemployment
   - [x] Adjustment occurs on many margins — hours, training, benefits, entry, automation — headcount is only one, and a uniform minimum cannot land inside every local market's “effective band”
   - [ ] Monopsony does not exist in reality
   > Austrians grant that monopsony may exist but note (a) Neumark–Wascher and others found the opposite, (b) the margins of adjustment go well beyond headcount, and (c) the “effective band” varies by market and cannot be known by the regulator — the knowledge problem.

5. The United States had gas lines in the 1970s and Europe did not. The most plausible explanation?
   - [ ] Europe had larger oil reserves
   - [x] The U.S. capped gasoline prices, so the price could not rise to clear the market and the gap became queues; Europe had no cap, so prices rose but nobody queued
   - [ ] Americans drove more
   - [ ] Europe imposed stricter rationing
   > The same supply shock: on one side prices rose and there were no queues; on the other the price was held, and the shortage appeared as time (queues) and uncertainty (“NO GAS”). After U.S. decontrol in 1981 the lines vanished within weeks.

## @further
- [Rothbard, Man, Economy, and State with Power and Market, Ch. 12 “The Economics of Violent Intervention” — the systematic treatment of price controls and minimum wages](https://mises.org/library/book/man-economy-and-state-power-and-market)
- [Diamond, McQuade & Qian, “The Effects of Rent Control Expansion on Tenants, Landlords, and Inequality: Evidence from San Francisco” (AER, 2019)](https://www.aeaweb.org/articles?id=10.1257/aer.20181289)
- [Econlib Encyclopedia: Rent Control (Walter Block)](https://www.econlib.org/library/Enc/RentControl.html)
- [Econlib Encyclopedia: Minimum Wages (Linda Gorman) — including the Card–Krueger vs Neumark–Wascher dispute](https://www.econlib.org/library/Enc/MinimumWages.html)
- [Mises, Human Action, Ch. 30 “Interference with the Structure of Prices”](https://mises.org/library/book/human-action)
