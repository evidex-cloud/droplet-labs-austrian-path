export default {
  ...
  stage: 1,
  order: 1,
  title: "Diamonds & Water: How the Marginal Revolution Cracked a 2,000-Year Paradox",
  difficulty: "intro",
...
The step looks small; its consequences were seismic. Before it, economists (Smith, Ricardo, Marx included) believed value came from what went into production — chiefly labor. Menger flipped the arrow of causation: **things are not valuable because labor was spent on them; the labor is valuable because consumers value what it makes.** The whole Austrian School — subjective value, price formation, capital theory, monetary theory, the business cycle — is derived downstream from that single reversal. Stage 1.2 unpacks “subjective,” Stage 1.3 shows how it becomes a market price, Stage 3.1 shows how it explains interest. By Stage 15.3 you will see it explains why software with zero marginal cost can sell for $200.
...
That is why the “Austrian School” is a school of its own rather than a branch of neoclassicism: **one revolution, two readings.** Stage 2.4 takes up how that split later became the long argument about math and equilibrium.
...
- If it is a psychological law, it can be measured, refuted by experiment, and written as a utility function — the Jevons–neoclassical road, and later the road on which behavioral economics “discovers” that people are irrational (Stage 11.5).
- If it is the logic of action, it is **a priori** true and applies to any purposeful actor whatever their psychology — the Menger–Mises road. Stage 2.1 takes that “a priori” apart properly.
...
$$
consumer's valuation of bread → price of bread → prices of flour, oven, labor → prices of wheat, iron ore
$$

and not the other way. Labor is valuable because what it makes is wanted; if you spend a thousand hours carving a wooden figure nobody wants, those thousand hours are worth zero — **cost is what you give up to produce something** (the opportunity cost of Stage 1.4), and what you give up is itself worth whatever consumers say it is.

The consequences of the reversal are enormous:

- **Marx's exploitation theory** loses its foundation: profit is not a surplus “deducted” from labor but the return for correctly anticipating consumers' valuations (Stage 6.3).
...
- **Zero-marginal-cost digital goods** become perfectly intelligible: copying software costs nothing, but its price is set by the marginal user's valuation, unrelated to the cost of copying (Stage 15.3).

The whole lesson in one sentence: **value lives in human minds, starts from consumers' valuations, and is imputed up the chain of production order by order; each unit is worth the importance of its marginal use.** In the next lesson (Stage 1.2) we take the phrase “lives in human minds” seriously — it is far more radical than it sounds.
`,
...
The picture also unlocks later lessons: the “marginal pairs” of Stage 1.3 are two companies poaching each other's staff, with the price pinned between the last pair willing to deal; the “demand for money” of Stage 4.2 is the question of which slot the last dollar in your ten thousand got assigned to; and the “network effects” of Stage 15.1 describe a strange company where every new hire makes **every** slot more important.
`,
  ...
  quiz: [
    {
      q: "You have 5 buckets of water, ranked by use: survival, cooking, the dog, washing, the cactus. Someone wants to buy one bucket. Under marginal-utility theory, which use do you reference when naming a price?",
      options: [
        "Survival — because water sustains life",
        "The average of all five uses",
        "The cactus — losing one bucket means giving up the least important use",
        "Cooking — because it is the middle value",
      ],
      answer: 2,
      explain: "**The value of the marginal unit**: 5 interchangeable buckets; lose any one and you cut the least important use, so every bucket is worth “the cactus.”",
    },
    {
      q: "Which three thinkers independently proposed marginal-utility theory around 1871?",
      options: [
      ...
      answer: 1,
      explain: "Jevons (England), Menger (Austria) and Walras (France/Switzerland) all arrived at “value is set by marginal utility”; Menger's refusal of mathematics and insistence on ordinal, subjective value is what made the Austrian School distinct.",
    },
    {
      q: "What is the Austrian basis for the law of diminishing marginal utility?",
      options: [
        "Psychological experiments showing people habituate to repeated stimuli",
        "An actor always uses each unit for the most important unsatisfied end, so the next unit must serve a less important one",
        "Statistics showing prices fall as consumption rises",
        "Production costs fall as output rises",
      ],
      answer: 1,
      explain: "It is a logical necessity derived from the **action axiom**, not an empirical regularity — so it holds for any purposeful actor regardless of psychology.",
    },
    {
      q: "Under Menger's theory of imputation, where does the price of flour come from?",
      options: [
        "From the labor spent growing wheat and milling it",
        "From the mill's cost plus a fair profit",
        "From consumers' valuation of bread, imputed upward through the price of bread to flour",
        "From a government reference price",
      ],
      answer: 2,
      explain: "A higher-order good (flour) gets its value from the lower-order good (bread) it helps make, and ultimately from consumers — **price determines cost**, not the reverse.",
    },
    {
      q: "A piece of software costs nothing to copy yet sells for $200. How does marginal-utility theory explain that?",
      options: [
        "It is a market failure; the price should approach zero",
        "The price is set by the marginal user's valuation, unrelated to the cost of copying",
        "Development costs are spread across every copy",
        "All software companies are monopolists",
      ],
      answer: 1,
      explain: "Value lives in the consumer's mind, not in cost. Zero copy cost only means supply can be unlimited; what the marginal user will pay depends on their valuation — Stage 15.3 develops this.",
    },
  ],

  further: [
    { label: "Carl Menger, Principles of Economics (1871) — full English text (Mises Institute)", url: "https://mises.org/library/book/principles-economics" },
    { label: "Mises, Human Action, Ch. VII “Action Within the World” — the praxeological derivation of marginal utility", url: "https://mises.org/library/book/human-action" },
    { label: "Adam Smith, Wealth of Nations, Book I Ch. IV — the classic statement of the paradox (Econlib)", url: "https://www.econlib.org/library/Smith/smWN.html" },
    { label: "Econlib Encyclopedia: Marginalism — a short history", url: "https://www.econlib.org/library/Enc/Marginalism.html" },
    { label: "Rothbard, Man, Economy, and State, Ch. 1 — the modern Austrian statement of utility and the margin", url: "https://mises.org/library/book/man-economy-and-state-power-and-market" },
  ],
};
