...
The argument is internally consistent on its own premise. The premise is: **price is determined by cost.** And that is exactly what Stage 1.1 spent an entire lesson overturning.
...
Then something more interesting appears. If price is valuation and valuations differ across people (Stage 1.2), then a *single* price is wasteful: it shuts out the person who would pay 30 while charging the person who would pay 300 only 200. So the history of digital pricing is the history of **entrepreneurs discovering the distribution of valuations**: free tier plus pro tier, student pricing, subscriptions, ad support, bundles, season passes, cosmetic skins — each one Kirznerian alertness (Stage 6.1), each one graded by profit and loss (Stage 6.3).

We also have three natural follow-ups. Do open source, Wikipedia and “gifting” transcend economics? If ideas are not scarce, what exactly is being paid for (the intellectual-property debate of Stage 9.1)? Does piracy really cause “losses”? And finally we must say honestly: how the fixed cost of the *first* copy — tens of millions or billions of dollars — gets recovered is something Austrians have no complete theory for, and that is where venture capital and the interest rate (Stages 3.1 and 5.2) enter the story.

**In this lesson we break it into six pieces:**

- **① Steelman first: P = MC, Arrow's dilemma and Rifkin's zero-marginal-cost society**
- **② The Stage 1.1 answer: price is the marginal buyer's valuation, cost is imputed backward**
...
The core of Stage 1.1 was an arrow of causation: **consumers' valuation → price of the final product → prices of the factors (costs)**, never the reverse. Menger called it imputation. Applied to digital goods:

- What a copy of software is worth depends on what the marginal buyer (the marginal pair of Stage 1.3) will pay.
...
- **Ad support**: selling users' attention to advertisers so the product is free to users — the price structure of the two-sided market in Stage 15.2 and the subject of Stage 16.1. Netflix's 2022 ad-supported tier is one more cut on the staircase.
...
The Austrian point here: **none of these price structures is derived from cost, and none is computed from a formula.** Adobe did not know whether subscriptions would work; Netflix did not know whether an ad tier would dilute the brand. Every attempt is Kirzner's alertness (seeing a group of unserved valuations) plus Mises's judgment (committing resources to the bet), then graded by the profit and loss of Stage 6.3. The mainstream's “optimal price discrimination” models assume the seller knows the demand curve; real sellers do not — they **discover** it. Stage 16.3's creator economy pushes this discovery down to the individual: a YouTuber's “free videos + memberships + merchandise + sponsorships” is versioning by one person.
...
The action axiom of Stage 2.1 says: **people act purposefully, using means to pursue ends.** It does not say the end must be money. Mises insisted throughout *Human Action* that economics studies all purposeful action, including charity, gift-giving and fighting for honor. So the question is not whether open source is economic behavior (of course it is) but **what means open-source contributors use to pursue what ends**:
...
- **Own use and collaboration**: many open-source projects begin as “I need this tool myself,” and opening the source is a way to get others to help fix it — a form of the division of labor and exchange of Stage 1.5, only the currency is labor rather than money.
...
So open source is not “beyond the market”; it is the market process extended to **non-monetary prices**: people still compare means and ends, still respond to rewards, still make entrepreneurial judgments (“will open-sourcing this get me what I want?”). It does not refute subjective value theory; it is a case of it: **when copying costs nothing, “giving it away” can itself be the cheapest means.** Stage 17.4 applies the same reasoning to the open-source governance of DeFi protocols.
...
- **Early access and identity**: seeing it first, limited skins, a creator's signed edition — high valuers are buying “first” and “belonging,” fully consistent with the subjectivity of valuation in Stage 1.2.
...
And the rehearsals, the composer — the $100 million cost of the “first copy” — who fronts it before the concert? Someone who believes “this band is worth it” (venture capital), borrowing at the going interest rate (Stage 3.1). When the rate is pushed too low, too many bands rehearse at once, halls fight over the same audience, and many bands discover the audience's valuations cannot cover the rehearsals. That is the malinvestment of Stage 5.2, with the stage swapped for software.
`,

  misconceptions: [
    "**“Digital goods have zero marginal cost, so their ‘correct’ price is zero and charging is monopoly.”** — Price is set by the marginal buyer's valuation, independent of copy cost. Zero marginal cost only means supply can be unlimited, not that valuation is zero. “Price = marginal cost” is a condition inside an equilibrium snapshot, not a cause of price formation; Stage 1.1 reversed that arrow long ago.",
    ...
    "**“Austrians have fully explained the zero-marginal-cost economy.”** — No. The price problem is solved; the fixed-cost problem only half: whether to invest in the first copy rests on entrepreneurial judgment, whether it can be financed on the interest rate, but Austrians lack a theory of price structure and firm size for “high fixed cost + zero marginal cost” industries, and have not placed venture capital within their capital theory. An open problem for Stage ∞.1.",
  ],

  quiz: [
    {
      q: "1,000 users have willingness to pay falling uniformly from $100 to $0. At a price of $50, what determines the price?",
      options: [
        "Copy cost (zero) plus a reasonable profit",
        "The valuation of user #500 — who just barely finds it worth $50 and is the marginal buyer",
        "The average of all users' valuations",
        "Development cost divided by the number of users",
      ],
      answer: 1,
      explain: "At $50, the 500 users with WTP ≥ 50 buy and user #500 is the marginal buyer (the marginal pair of Stage 1.3). Revenue of 25,000 comes entirely from the staircase's shape; no number comes from cost.",
    },
    {
      q: "Replace the single $50 price with two tiers (Pro at 80, Basic at 40) in the example above. What happens?",
      options: [
        "Revenue falls, because some people drop from 50 to 40",
        "Revenue rises from 25,000 to 32,000 and users from 500 to 600 — revenue and coverage rise together",
        "Users and revenue are unchanged",
        "It violates antitrust law",
      ],
      answer: 1,
      explain: "The 200 users with WTP 80–100 buy Pro (16,000); the 400 with WTP 40–80 buy Basic (16,000). Versioning lets users sort themselves by valuation — entrepreneurs discovering the distribution, not deriving prices from cost.",
    },
    {
      q: "How do Austrians view open-source software?",
      options: [
        ...
        "It is purposeful action: free bits exchanged for reputation, complement sales, collaboration and competitive advantage — a case of subjective value theory",
        "It can only exist with government funding",
      ],
      answer: 2,
      explain: "The action axiom does not require money as the end. Red Hat sold services and was bought by IBM for about $34 billion; programmers trade open-source work for ability signals; big firms open-source to weaken rivals — all comparisons of means and ends.",
    },
    {
      q: "What is the core of Kinsella's argument “against intellectual property”?",
      options: [
        "Ideas are not scarce, so “ownership” of an idea is really a state-granted restriction on the use of other people's tangible property — a monopoly privilege",
      ...
      answer: 0,
      explain: "Property is a rule for resolving conflict over scarce resources (Stage 9.1); ideas are not scarce, so “you may not use your computer to copy these bits” restricts your tangible property. Austrians differ on copyright, but the direction is shared.",
    },
    {
      q: "Why were so many “burn cash for users now, price later” digital projects financed in the zero-rate era, and why did they contract sharply after rates rose in 2022?",
      options: [
        "Because network effects disappeared",
        "Because fixed costs are paid today and revenue arrives over years; the lower the rate, the higher the present value of distant revenue and the more long-payback projects get approved — with rates artificially suppressed, too many launched at once: malinvestment in digital form",
        "Because governments stopped subsidizing them",
        "Because consumers' valuations suddenly fell",
      ],
      answer: 1,
      explain: "This is the time preference of Stage 3.1, the roundabout production of Stage 3.2 and the malinvestment of Stage 5.2 applied to the digital economy. Stage 18.5 applies the same logic to AI capex.",
    },
  ],

  further: [
    { label: "Shapiro & Varian, Information Rules (1998), Ch. 3 “Versioning Information” — the original treatment of versioning", url: "https://www.inforules.com/" },
    ...
    { label: "Boldrin & Levine, Against Intellectual Monopoly (2008) — full text online", url: "http://www.dklevine.com/general/intellectual/againstfinal.htm" },
    { label: "Rothbard, Man, Economy, and State, Ch. 10 — the Austrian statement on cost, sunk cost and pricing", url: "https://mises.org/library/book/man-economy-and-state-power-and-market" },
    { label: "Mises, Human Action, Ch. XVI “Prices” — price formation and the imputation of costs", url: "https://mises.org/library/book/human-action" },
  ],
};
