...
# Entrepreneurship: Kirzner's Alertness & Mises's Judgment
...
Why does this deserve an entire stage of the course? Because the central models of mainstream economics — perfect competition, general equilibrium — **assume the entrepreneur out of existence.** All information is given, all prices are already at equilibrium, nobody needs to “see” anything, and there is no uncertainty to “bear.” The assumption makes the mathematics elegant; the cost is deleting the market's engine. [[competition-process|Stage 6.2]] shows why competition is a process and not a state; [[profit-loss|Stage 6.3]] shows how profit and loss work as a feedback system; [[monopoly-question|Stage 6.4]] tackles monopoly. All three rest on this lesson's foundation. Further on, the accelerating creative destruction of [[creative-destruction|Stage 15.5]], the creator economy of [[creator-economy|Stage 16.3]], and the question in [[ai-judgment|Stage 18.3]] of whether “AI can automate judgment” all come back to the two words defined here.
...
$$
\begin{aligned}
&\text{Price in B } 1.60 - \text{price in A } 1.00 - \text{freight } 0.30 \\
&\quad = 0.30 \text{ pure profit per apple}
\end{aligned}
$$
...
This is what Kirzner means by calling the entrepreneur an **equilibrating** force: every successful arbitrage pushes the market one step closer to “one good, one price.” Note that he does not say the market **arrives** at equilibrium — new changes (harvests, tastes, technology) keep creating new discoordination — only that the entrepreneur's direction is **toward** it. This is the other face of Hayek's argument in [[hayek-knowledge|Stage 7.2]] about how dispersed knowledge gets used: Hayek explains that prices **transmit** knowledge; Kirzner explains **who** stuffs the knowledge into the price.
...
Here Frank Knight comes in. In *Risk, Uncertainty and Profit* (1921) Knight separated **risk** (probabilities known; insurable and poolable — fire, for instance) from **uncertainty** (probabilities unknowable, because the event is unique — “will consumers like this new drink next year?”). Risk can be priced, so it yields no profit; **only uncertainty yields profit**, because whoever bears it cannot sell it to anyone else. Mises and Knight agree completely on this point: **profit is the reward for bearing genuine uncertainty.** It also echoes the action axiom of [[action-axiom|Stage 2.1]] — action is action precisely because the future is open; if everything were settled there would be only mechanical response, not choice.
...
$$
\begin{aligned}
\text{B at }\$2.00\text{ (shortage):} &\quad \text{revenue } 2{,}000 - \text{cost } 1{,}300 = +700 \\
\text{B at }\$1.60\text{ (as usual):} &\quad \text{revenue } 1{,}600 - \text{cost } 1{,}300 = +300 \\
\text{B at }\$1.20\text{ (a big dealer arrives):} &\quad \text{revenue } 1{,}200 - \text{cost } 1{,}300 = -100
\end{aligned}
$$
...
Still, Schumpeter does remind us of something Kirzner's pure-arbitrage model underplays: **entrepreneurs often do not passively “discover” demand; they actively create things consumers did not know they wanted** (nobody in 2006 “needed” a touchscreen phone). This matters enormously in [[creative-destruction|Stage 15.5]] on creative destruction at internet speed — the internet has made experiments in “new combinations” extremely cheap, so the rhythm of creative destruction has shortened from decades to years.
...
- **The capitalist** supplies funds and bears waiting — his return is **interest** (the time preference of [[time-preference|Stage 3.1]]).
...
$$
\begin{aligned}
\text{Entrepreneurship} &= \text{alertness (seeing the opportunity)} \\
&\quad \times \text{judgment (staking resources, bearing uncertainty)}
\end{aligned}
$$

Neither works alone. Alertness without judgment is a “commentator”; judgment without alertness is a “gambler.” The market pays profit to those who have both and charges losses to anyone in whom either has failed — **and that is the engine of the market process.** In the next lesson ([[competition-process|Stage 6.2]]) we watch this engine run when many entrepreneurs compete with one another.
...
Looking ahead: [[profit-loss|Stage 6.3]] shows how the market grades every stallholder with profit and loss; [[creator-economy|Stage 16.3]] asks what happens when a stall becomes an account on a phone and millions of people are doing both things simultaneously; and [[ai-judgment|Stage 18.3]] considers an AI that can help the first person find gaps faster and the second estimate probabilities better — but cannot replace either of them at the moment of **staking**.
...
- **“With AI and big data, entrepreneurial judgment can be replaced by algorithms.”** — Algorithms handle risk (known probabilities); they cannot handle Knightian uncertainty (unique events). More fundamentally, judgment by definition includes bearing the consequences with resources you own. AI is a capital good: it can make judgment faster and better informed, but the person who decides and absorbs the loss is still human ([[ai-judgment|Stage 18.3]]).

## @quiz
1. Apples are $1.00 in Town A and $1.60 in Town B; freight is $0.30. Zhang ships 1,000 apples and sells them. On Kirzner's analysis, what is the $300 he earns a reward for?
   - [ ] The labor of hauling the apples
   - [ ] Interest on the money he advanced
   - [x] The discovery of a price gap nobody else had noticed
   - [ ] An insurance premium for bearing transport risk
   > Hauling earns wages, capital earns interest, insurable risk earns a premium — all already in the costs. The remaining $300 is **pure entrepreneurial profit**, born of alertness: the gap was there all along; nobody had noticed.

2. Why does Kirzner call the entrepreneur's action “equilibrating”?
   - [ ] Because entrepreneurs comply with government price guidance
   - [x] Because arbitrage itself raises the low price and lowers the high one, squeezing the gap toward the cost of transport
   ...
   > Zhang's buying pushes A's price up; his selling pushes B's price down; imitators follow, and the gap tends toward $0.30. **Profit destroys itself in the act of being earned**, and in doing so presses dispersed information into a more accurate price.

3. Knight distinguishes “risk” from “uncertainty.” Which of the following is uncertainty?
   - [ ] On average 2% of apples spoil in transit
   - [x] Whether a bigger competitor will appear in Town B next week
   - [ ] The annual probability of a warehouse fire
   - [ ] The probability of rolling a six
   > Spoilage rates, fires and dice all have frequencies to consult; they can be priced and insured — that is risk. “Next week in Town B” happens once; there is no frequency, only **judgment** and its consequences — the uncertainty that generates profit.

4. On Foss and Klein's definition, what must “judgment” involve?
   - [ ] An MBA and a market-research study
   - [ ] A forecast about the future, publicly stated
   - [x] A decision, under uncertainty, about deploying heterogeneous resources that you own
   - [ ] Computing the probabilities of each outcome and picking the highest expected value
   > Three keywords: **uncertainty** (not known probabilities), **ownership** (bearing the consequences with your own resources — otherwise it is opinion), and **heterogeneous resources** (deciding how the jigsaw fits). This is also why judgment cannot be bought and why firms exist.

5. What is the core of Rothbard's criticism of Kirzner's “pure entrepreneur”?
   - [ ] Kirzner underestimates the role of regulation
   - [x] Someone who owns no resources cannot lose, yet loss is the market's most important corrective
   ...
   > Rothbard held that an ownerless “entrepreneur” can only win and never lose, and is therefore an empty concept; the real entrepreneur is the capitalist-entrepreneur who stakes capital. Kirzner replied that the pure entrepreneur is an abstraction separating profit's **source** from its **bearer**.

## @further
- [Israel Kirzner, Competition and Entrepreneurship (1973) — the original statement of alertness and the pure entrepreneur (Mises Institute)](https://mises.org/library/book/competition-and-entrepreneurship)
- [Mises, Human Action, Chapters XIV–XV — the evenly rotating economy and the entrepreneurial function](https://mises.org/library/book/human-action)
- [Frank Knight, Risk, Uncertainty and Profit (1921), full text (Econlib)](https://www.econlib.org/library/Knight/knRUP.html)
- [Foss & Klein, Organizing Entrepreneurial Judgment (Cambridge University Press, 2012) — the judgment-based theory of the firm](https://doi.org/10.1017/CBO9781139021173)
- [Kirzner, “Entrepreneurial Discovery and the Competitive Market Process: An Austrian Approach,” Journal of Economic Literature (1997) — Kirzner's systematic reply to his critics](https://www.jstor.org/stable/2729693)
