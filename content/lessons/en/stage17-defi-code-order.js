export default {
  ...
  stage: 17,
  order: 4,
  title: "DeFi & Smart Contracts: Spontaneous Order in Code",
  difficulty: "newera",
  prereqs: ["spontaneous-law", "price-formation"],

  oneLiner:
    "In 2018 an unemployed mechanical engineer wrote an “exchange” in a few hundred lines of code: no matching engine, no order book, no market makers, just one formula, x·y = k. Today such “automated market makers” handle billions of dollars a day. It is a touchstone for Austrian theory: **can a hard-coded rule form a price?** The answer is no — but it can make life easier for the people who do form prices (arbitrageurs). This lesson reads smart contracts with the “rules vs order” of Stage 7.4, AMMs with the marginal pairs of Stage 1.3, oracles with the calculation problem of Stage 7.1, the bankruptcy of “code is law” (The DAO, 2016) with the lex mercatoria of Stage 9.3, and DeFi lending and the Terra collapse (2022) with the reserve framework of Stage 4.4. Austrian theory is strong here, but it has two pieces of homework left: governance tokens and MEV. (Nothing here is investment advice.)",

  intuition: `
Recall the core distinction of Stage 7.4. Hayek said there are two kinds of order in the world: an **organization** (taxis), designed for a purpose, with a director — a firm, an army; and a **spontaneous order** (cosmos), designed by nobody, growing out of the actions of people who follow some abstract rules — language, the market, the common law. Rules may be designed (traffic law), but the order that grows on top of them (traffic) is not. Stage 9.3 showed that law itself can “grow”: the medieval lex mercatoria was not decreed by kings; it settled out of merchants' arbitration and custom in cross-border trade.
...
**First, automated market makers (AMMs).** In an ordinary market, price is pinned by the **marginal pairs** of Stage 1.3: the last buyer and seller willing to deal set the range. An AMM has no bids and asks, only a pool and a formula: the quantity of coin A in the pool times the quantity of coin B equals a constant k. Take A out and you must put in enough B to keep the product unchanged; the more you take, the higher the price per unit. **The price is not “discovered”; it is “computed”** — so is it still a price? The Austrian answer is interesting: the AMM discovers nothing; it is a passive quoting rule. What pulls its price to the “right” place is the **arbitrageur** outside — the embodiment of Kirznerian alertness from Stage 6.1. Without arbitrageurs, an AMM's price is a stopped clock.

**Second, DeFi lending.** Aave, Compound and MakerDAO all require **over-collateralization**: to borrow $100 of stablecoin you first lock $150 of ether. That is the exact reverse of the fractional-reserve bank of Stage 4.4 — the bank makes $100 of loans on $10 of reserves; DeFi makes a $100 loan against $150 of collateral. It means DeFi lending **does not create money** (except for minted stablecoins like DAI, which we treat separately), and so it does not trigger the cycle mechanism of Stage 5.1 — its interest rate reflects real loanable funds. It is the structure the 100%-reserve camp of Stage 9.4 would like.

**Third, oracles.** A smart contract cannot know on its own “what ether is worth in dollars right now” — it is a sealed program. Someone must feed the price in from outside; that feeder is an oracle. This is a code-level proof of Mises's 1920 argument in Stage 7.1: **calculation needs prices, prices can only come from markets, and code cannot produce them.** In 2022 an exchange lost about $100 million to oracle manipulation — reference a thin market's price and you have imported its fragility.

**Fourth, “code is law.”** Early DeFi's slogan was: whatever the contract says, that is the outcome; no courts, no appeals. In June 2016 a crowdfunding contract called The DAO was drained of about a third of its funds through a bug — **in strict accordance with the code's literal logic.** The Ethereum community then voted to “hard fork” and reverse the transaction, in effect declaring “code is not law; our consensus is.” That is the lesson of Stage 9.3: **rules always need interpretation and enforcement, even when written in code**; a buggy contract is an ambiguous contract. The lex mercatoria did not disappear; it moved from a Venetian arbitration hall to a Discord vote.

We will also look at Terra's collapse in May 2022: an algorithmic stablecoin with no reserves, holding its $1 peg by a “mint-and-burn” mechanism, which evaporated about $40 billion in a week. Not a hack, not a fraud — the mechanism **working as designed.** It is the bank-run theory of Stage 4.4 tested on a kind of bank that had never existed.

Finally, an honest account of Austrian strengths and weaknesses here. Strengths: price discovery, rules vs commands, reserve analysis, the calculation problem — each seems tailor-made for DeFi. Weaknesses: **governance tokens** (voting rights can be bought and sold, so a protocol's “constitution” becomes an asset a whale can acquire) and **MEV** (miners/validators can reorder transactions to extract rent) — both challenge the premise that “rules apply equally to all,” and Austrians have no ready theory. Stage 18.6, on algorithmic pricing and AI-agent economies, picks up that thread.
...
Taken together: **the bulk of DeFi (over-collateralized lending) creates no money and is not a cycle engine; its edge (minted stablecoins) creates money substitutes whose hardness depends on the collateral rule; its failures (algorithmic stablecoins) are reserveless issue.** Stage 17.5 carries this three-way division over to custodians under a Bitcoin standard.
...
It looks like a technical detail; it is a clean experimental confirmation of Mises's argument in Stage 7.1. Mises said in 1920: no market, no prices; no prices, no economic calculation — a planner may have all the technical knowledge in the world and still not know whether a ton of steel should become a bridge or a ship, because he has no prices to compare. DeFi turned that into a coding constraint: **no matter how sophisticated a contract, it cannot generate a price; it can only reference a price formed by a market (by marginal pairs!).** When Stages 7.5 and 18.1 ask whether big data or AI can plan, this example bears repeating: a system executing thousands of trades a second still has to reach out to human markets for prices.
...
The Austrian summary is not “oracles are bad” but: **prices are the result of acting people exchanging under scarcity; any system — code, AI, a planning board — can only consume them, never manufacture them.** That is all of Stage 7.1, except that this time the objector is not Lange but a contract.
...
The framework of Stage 9.3 applies almost line by line:
...
**Why it collapsed.** From 7 May 2022 UST met heavy selling and broke its peg. The arbitrage mechanism kicked in: people swapped UST for LUNA and sold it, LUNA's supply ballooned and its price fell; the lower LUNA fell, the more LUNA had to be minted for each UST redeemed, the faster supply grew — **a positive feedback loop.** Once LUNA's total market value fell below UST's outstanding supply, the promise “1 UST for $1 of LUNA” became mathematically impossible to honour for everyone. Within a week UST traded at a few cents, LUNA fell from about $80 to nearly nothing, about $40 billion evaporated, and the chain of failures Stage 17.5 describes — Celsius, Three Arrows Capital — began.

**The Austrian reading.** This is the extreme case of the bank-run theory of Stage 4.4: a “bank” whose reserve is its own equity. Mises's definition of a money substitute requires “redeemable at par on demand”; Terra offered “redeemable on demand into something whose price is set by the act of redemption itself” — that is not a reserve, it is **reflexivity** (Stage 16.5). When the main reason to hold UST was a 20% yield rather than its use, demand was speculative, and speculative demand in a panic has only one direction. **It worked as designed; the design was a run waiting to happen.**

**Austrian strengths, named one by one:**

- Stages 1.3 / 6.1: AMMs do not discover prices; arbitrageurs do — the Austrian market-process theory explains what an AMM does better than any equilibrium model.
- Stages 7.4 / 9.3: rules vs commands, rules needing interpretation — The DAO and the CBDC contrast have no ready framework in other schools.
- Stages 4.4 / 9.4: the three-way division of over-collateralized, fractional and reserveless directly determines which DeFi structures generate cycles.
- Stage 7.1: oracles are an experimental proof of the calculation problem.
...
- **MEV (maximal extractable value).** Validators decide the order of transactions within a block, so they can insert their own buy before your large buy and their sell after it (a “sandwich attack”), extracting rent from your slippage. That challenges “rules apply equally to all”: in DeFi the bookkeeper and the trader are not equal. Austrian market-process theory assumes a neutral trading venue; when the venue is itself a rent-extracting participant, the theory needs extending. A 2019 paper titled “Flash Boys 2.0” first described it systematically. When Stage 18.6 turns to algorithmic pricing and AI agents trading with one another, MEV is one of the questions that must be answered.

The lesson in one sentence: **code can automate the enforcement of rules; it cannot automate the discovery of prices, the interpretation of rules, or the honesty of reserves — those three still depend on acting people.** Stage 17.5 asks next: if the base money were Bitcoin, could custodians still manufacture cycles? This lesson is not investment advice.
`,
...
`,
  ...
  quiz: [
    {
      q: "A Uniswap pool holds 100 ETH and 200,000 USDC. The outside market drops ETH to $1,800 but nobody trades. What happens to the pool price?",
      options: [
        "It automatically follows the outside market to 1,800",
        "It stays at 2,000 until an arbitrageur sells ETH into the pool and pushes it to 1,800",
        "It rises to 2,200 because k is constant",
        "It becomes 1,900, the average of the two",
      ],
      answer: 1,
      explain: "An AMM is a passive quoting rule that knows nothing of the outside world. The price is carried in by arbitrageurs' actions (Stage 6.1) — a market process, not a formula.",
    },
    {
      q: "Why does Aave/Compound-style over-collateralized lending not trigger the Austrian business cycle?",
      options: [
        "Because it is regulated",
        "Because the interest rate is fixed",
        "Because what is lent is what was deposited, no new money is created, and the rate reflects real loanable funds",
        "Because blockchains cannot have cycles",
      ],
      answer: 2,
      explain: "Stage 5.1's cycle starts when credit expansion (loanable funds conjured from nothing) depresses the rate; over-collateralized pool lending creates no money, and maturity mismatch is rationed by rate, not suspension.",
    },
    {
      q: "What does the existence of oracles mean for Mises's 1920 argument in Stage 7.1?",
      options: [
        "It refutes it: code can compute prices on its own",
        "It confirms it: however sophisticated, a contract cannot generate a price; it can only reference a market-formed price and inherits its fragility",
        "It is unrelated",
        "It proves big data can replace markets",
      ],
      answer: 1,
      explain: "A blockchain is a closed system; prices must be fed in from outside markets. Mango Markets, Black Thursday and flash-loan attacks all show that referencing a price means referencing its fragility.",
    },
    {
      q: "In the framework of Stage 9.3, what did the Ethereum community's 2016 hard fork over The DAO signify?",
      options: [
        "Code is law, so the fork was illegitimate",
        "The state intervened in the blockchain",
        "When a rule's text conflicts with the community's expectation, the community interprets and enforces by reputation rather than force — the return of the lex mercatoria",
        "Ethereum came under central control by its foundation",
      ],
      answer: 2,
      explain: "Leoni: law is shared expectation, the text merely a record. The fork was a community's ruling in “equity,” and dissenters formed Ethereum Classic — a spontaneous order is not one without interpreters, but one whose interpreters are not the state.",
    },
    {
      q: "What was the core mechanism of the Terra/UST collapse in 2022?",
      options: [
        "Its dollar reserves were stolen",
        "Its “reserve” was the protocol's own LUNA; redeeming UST minted more LUNA and depressed its price in a positive feedback loop; once LUNA's market value fell below UST's supply the promise was mathematically unpayable",
        "Regulators shut it down",
        "The oracle reported a wrong price",
      ],
      answer: 1,
      explain: "A run on reserveless issue: the reserve was its own equity, and the act of redemption destroyed the reserve's value (Stage 4.4 + 16.5). Anchor's 20% yield made demand highly speculative and accelerated the one-way stampede.",
    },
  ],

  further: [
    { label: "Mises, “Economic Calculation in the Socialist Commonwealth” (1920) — the theoretical root of the oracle problem", url: "https://mises.org/library/book/economic-calculation-socialist-commonwealth" },
    { label: "Hayek, Law, Legislation and Liberty, Vol. 1: Rules and Order (1973) — rules and order, taxis and cosmos", url: "https://press.uchicago.edu/ucp/books/book/chicago/L/bo3629429.html" },
    { label: "Bruno Leoni, Freedom and the Law (1961) — law as shared expectation (Liberty Fund full text)", url: "https://oll.libertyfund.org/titles/leoni-freedom-and-the-law-lf-ed" },
    { label: "Böhm-Bawerk, The Positive Theory of Capital (1889), Book IV — marginal pairs and the horse market", url: "https://mises.org/library/book/positive-theory-capital" },
    { label: "Daian et al., “Flash Boys 2.0: Frontrunning, Transaction Reordering, and Consensus Instability in Decentralized Exchanges” (2019) — the first systematic description of MEV", url: "https://arxiv.org/abs/1904.05234" },
  ],
};
